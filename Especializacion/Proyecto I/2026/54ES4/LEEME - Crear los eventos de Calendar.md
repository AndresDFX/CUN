...
**Grupo 54ES4** · lunes 20:00–22:00 · **11 encuentros** · **53 estudiantes invitados**

> **Archivo generado — no editar a mano.** Regenerar: `python config/slides/build_calendar_encuentros.py proyecto1`

## Qué vas a conseguir

Los **11 encuentros** del periodo (10/08/2026 → 09/11/2026) en tu Google Calendar, cada uno con **los 53 estudiantes del grupo 54ES4** en la sección *Invitados* y con **el mismo enlace de Google Meet** en todos. Unos cinco minutos. No hay que crear la sala a mano: la crea el propio script.

## ⚠️ Lo primero: no importes el `.ics`

Google Calendar **descarta la lista de invitados** al importar `.ics` y `.csv`. No es un defecto de estos archivos: es cómo Google trata esos formatos. Si importas el `.ics` de esta carpeta te quedan los 11 eventos **con cero de los 53 estudiantes**, y encima ya no puedes usar el script sin borrarlos antes.
...
| `NO USAR - Actualizar Meet en encuentros (mismo enlace).gs` | ⛔ **NO EJECUTAR.** Pone el MISMO enlace en todos los encuentros, y desde el 31/08/2026 cada sesión tiene el suyo: correrlo machacaría los enlaces que los estudiantes ya tienen en su Calendar. Se conserva solo por si algún curso vuelve al enlace único. |
...
|---|---|---|---|
| 01 | 10/08/2026 (lunes) | Presentación del curso · docente · estudiantes · ACAs | 53 |
| 02 | 24/08/2026 (lunes) | Problema y pregunta de investigación | 53 |
| 03 | 31/08/2026 (lunes) | Objetivos, justificación, alcances y limitaciones | 53 |
| 04 | 07/09/2026 (lunes) | Retroalimentación del Quiz · Antecedentes de investigación | 53 |
| 05 | 14/09/2026 (lunes) | Marco teórico | 53 |
| 06 | 21/09/2026 (lunes) | Marco conceptual y marco contextual | 53 |
| 07 | 28/09/2026 (lunes) | Marco legal · citación APA 7 | 53 |
| 08 | 05/10/2026 (lunes) | Diseño metodológico: paradigma, enfoque y alcance | 53 |
| 09 | 19/10/2026 (lunes) | Devolución de la ACA 1 · población, muestra e instrumentos propuestos | 53 |
| 10 | 26/10/2026 (lunes) | Planeación, viabilidad e integración del anteproyecto | 53 |
| 11 | 09/11/2026 (lunes) | Integración y evaluación · coevaluación y autoevaluación | 53 |
