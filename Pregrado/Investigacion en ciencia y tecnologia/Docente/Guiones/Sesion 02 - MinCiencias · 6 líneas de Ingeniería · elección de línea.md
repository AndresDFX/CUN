### GUIÓN DOCENTE — Sesión 02: MinCiencias · 6 líneas de Ingeniería · elección de línea
...
📌 **De esta sesión**
- **Sesión:** **02** · **Tema:** MinCiencias · 6 líneas de Ingeniería · elección de línea
...
| **16** | TALLER · Línea elegida + justificación |
| **17** | TALLER · cómo se revisa y dónde se entrega |
| **18** | Checklist antes de cerrar su avance |
...
#### 1. ¿Qué es MinCiencias y por qué le importa a su artículo?
...
Tema 'phishing en correos de estudiantes' → línea **Inteligencia Artificial** (detección de correos maliciosos), justificada por la abundancia de datasets y literatura.

#### Errores frecuentes
| Error frecuente / pregunta trampa | Qué responde el docente |
| :--- | :--- |
| “Elijo IA porque está de moda.” | La moda no da datos: elija donde haya fuentes accesibles y afinidad con su tema. |
| “Puedo trabajar en tres líneas a la vez.” | No: una línea principal. Tres líneas = ningún marco sólido. |
| “La línea es un requisito administrativo.” | Define su vocabulario y sus referentes; cambiarla luego obliga a reescribir el marco. |
| “Mi tema no cabe en ninguna línea.” | Casi siempre cabe; ayúdelo a re-encuadrar hacia la línea más cercana. |
...
#### 3️⃣ Criterios de elección (~10 min) — Modelación en pantalla
...
![Google Docs — tabla de decisión de línea](Capturas/inv_google_docs.png)
...
![Google Académico — 2 referentes de la línea](Capturas/inv_google_scholar.png)
