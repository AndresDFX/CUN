...
🗺️ **Slides de esta presentación** (deck real: **27 slides** — no es el mapa del curso)
...
| **21** | TALLER — Validar por dentro y por fuera (25 minutos) |
| **22** | TALLER — Validar por dentro y por fuera (25 minutos) (cont.) |
...
![Canvanizer — Business Model Canvas en vivo](Capturas/Herramientas/bmc_canvanizer.png)
...
![Docs — tablero de vigilancia (5 columnas)](Capturas/s01_google_docs_inicio.png)
...
![Excalidraw — FODA + MVP en 5 líneas](Capturas/s01_excalidraw_pizarra.png)

> **En pantalla:** FODA de 6 bullets con interna/externa separadas y el MVP escrito al lado.

![Docs — un solo documento con las dos mitades](Capturas/s01_google_docs_inicio.png)

> **En pantalla:** Títulos «A. Validación» y «B. Vigilancia»; se exporta a PDF y se sube a CDigital.

#### 4️⃣ Taller: validar por dentro y por fuera (~9 min) — Protagonista: Estudiantes
**Slides del deck:** **17–22** · «Errores frecuentes y respuestas» → «Paso a paso: un solo documento con las dos mitades» → «TALLER — Validar por dentro y por fuera (9 minutos)»
...
**Slides del deck:** **23–27** · «Antes de entregar: revise usted mismo» → «Para continuar — trabajo autónomo» → «Cierre — Sesión 05»
