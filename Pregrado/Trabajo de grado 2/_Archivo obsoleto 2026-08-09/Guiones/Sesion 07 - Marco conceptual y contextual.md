### GUIÓN DOCENTE — Sesión 07: Marco conceptual y contextual
...
> **PPTX:** `Clases/Sesion 07 - Marco conceptual y contextual/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **07** · **Tema:** Marco conceptual y contextual
- **Detalle:** Definiciones operativas.
- **PPTX estudiante:** `Clases/Sesion 07 - Marco conceptual y contextual/Presentacion.pptx`
...
Definiciones operativas + contexto real del proyecto.

#### Práctica
Solo herramientas gratis en la nube (Docs, Scholar, ZoteroBib, Excalidraw).

#### Ejemplo modelo para clase
Contexto = organización/proceso, no país entero.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **07**: *Marco conceptual y contextual*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Contexto = organización/proceso, no país entero.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Tabla de términos + 1 página contextual. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Marco conceptual y contextual*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S07_ConceptualContextual_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Tabla de términos + 1 página contextual.
2. Archivo en CDigital: `S07_ConceptualContextual_Apellido`.
