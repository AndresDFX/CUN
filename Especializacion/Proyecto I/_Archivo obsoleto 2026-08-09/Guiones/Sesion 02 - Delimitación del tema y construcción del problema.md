### GUIÓN DOCENTE — Sesión 02: Delimitación del tema y construcción del problema
...
> **PPTX:** `Clases/Sesion 02 - Delimitación del tema y construcción del problema/Presentacion.pptx` (referencia solo estas slides).

📌 **De esta sesión**
- **Sesión:** **02** · **Tema:** Delimitación del tema y construcción del problema
- **Detalle:** Líneas de investigación IA · formulación del problema.
- **PPTX estudiante:** `Clases/Sesion 02 - Delimitación del tema y construcción del problema/Presentacion.pptx`
...
> “Buenas tardes. Sesión 02: *Delimitación del tema y construcción del problema*. Al terminar deben salir con un avance
...
- [ ] Tengo la presentación `Clases/Sesion 02 - Delimitación del tema y construcción del problema/Presentacion.pptx`
