### GUIÓN DOCENTE — Sesión 07: Taller de consolidación y sustentación de la propuesta

> **Uso:** guion de **cierre**. Esta sesión **no dicta contenido nuevo y no evalúa contenido**: la ACA Final y el Quiz 3 ya cerraron.
> Lo que pasa hoy es sustentación con el pitch, retroalimentación entre pares, revisión de coherencia del documento y apertura de auto y coevaluación.
> Léalo en voz alta casi literal. Estudie primero el Fundamento Teórico. **Duración: 60 minutos**.
> Logística de semestre (fechas, grupos, cortes) → Presentación del Curso / Manual.
> **PPTX:** `Clases/Sesion 07 - Taller de consolidación y sustentación de la propuesta/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **07** · **Tema:** Taller de consolidación y sustentación de la propuesta
...
- **PPTX estudiante:** `Clases/Sesion 07 - Taller de consolidación y sustentación de la propuesta/Presentacion.pptx`
...
| :---: | :--- |
| **1** | SESIÓN 07 — Taller de consolidación y sustentación de la propuesta |
| **2** | Hoy no se entrega nada nuevo: hoy se sostiene lo que ya escribió |
| **3** | El hilo completo de su Propuesta de Innovación |
| **4** | Trazabilidad: qué sesión produjo qué sección del documento |
| **5** | Cómo se sustenta una propuesta en tres minutos |
| **6** | Cómo se sustenta una propuesta en tres minutos (cont.) |
| **7** | Las cinco preguntas que le van a hacer (y cómo se responden) |
| **8** | Retroalimentar bien: la fórmula de las tres frases |
| **9** | Retroalimentar bien: la fórmula de las tres frases (cont.) |
| **10** | Rúbrica de la ronda: qué mirar cuando escucha a un compañero |
| **11** | Consolidar es revisar costuras, no escribir más |
| **12** | Autoevaluación y coevaluación: qué son y cómo se diligencian |
| **13** | Autoevaluación y coevaluación: qué son y cómo se diligencian (cont.) |
| **14** | TALLER · Sustentación cruzada y consolidación |
| **15** | TALLER · cómo se revisa y dónde se entrega |
| **16** | Errores frecuentes en la sustentación |
| **17** | Errores frecuentes en la sustentación (cont.) |
| **18** | Qué hacer con esta propuesta después del curso |
| **19** | Cierre del curso · últimos pendientes |
| **20** | Cierre del curso · últimos pendientes (cont.) |
| **21** | RUTA DE ENTREGABLES DEL CURSO |
| **22** | Cierre — Sesión 07 |
...
🎯 **Objetivos de la sesión** *(cierre: no hay contenido nuevo del Syllabus)*
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre de cierre: hoy se sostiene lo que ya escribió | 5 | min 00:00 – 05:00 |
| 2️⃣ El hilo completo y la trazabilidad del documento | 7 | min 05:00 – 12:00 |
| 3️⃣ Cómo se sustenta en tres minutos · las cinco preguntas | 8 | min 12:00 – 20:00 |
| 4️⃣ Retroalimentar con criterio y revisar costuras | 7 | min 20:00 – 27:00 |
| 5️⃣ Taller: sustentación cruzada y consolidación | 17 | min 27:00 – 44:00 |
| 6️⃣ Autoevaluación · Coevaluación en el aula | 8 | min 44:00 – 52:00 |
| 7️⃣ Cierre del curso | 8 | min 52:00 – 60:00 |
...
**Slides del deck:** **1–2** · «SESIÓN 07 — Taller de consolidación y sustentación de la propuesta» → «Hoy no se entrega nada nuevo: hoy se sostiene lo que ya escribió»
...
**Slides del deck:** **3–4** · «El hilo completo de su Propuesta de Innovación» → «Trazabilidad: qué sesión produjo qué sección del documento»
...
![Docs — la propuesta consolidada, sección por sección](Capturas/s01_google_docs_inicio.png)

> **En pantalla:** Recorrer el documento del caso del laboratorio y mostrar dónde se rompen las costuras.

#### 3️⃣ Cómo se sustenta en tres minutos · las cinco preguntas (~8 min) — Protagonista: Docente
**Slides del deck:** **5–7** · «Cómo se sustenta una propuesta en tres minutos» → «Las cinco preguntas que le van a hacer (y cómo se responden)»
...
**Slides del deck:** **8–16** · «Retroalimentar bien: la fórmula de las tres frases» → «Rúbrica de la ronda: qué mirar cuando escucha a un compañero» → «Consolidar es revisar costuras, no escribir más» → «Errores frecuentes en la sustentación»
...
![Excalidraw — rúbrica de la ronda a la vista](Capturas/s01_excalidraw_pizarra.png)

> **En pantalla:** Los cuatro criterios escritos en pantalla mientras un compañero sustenta.

#### 5️⃣ Taller: sustentación cruzada y consolidación (~17 min) — Protagonista: Estudiantes
**Slides del deck:** **14–15** · «TALLER · Sustentación cruzada y consolidación» → «TALLER · cómo se revisa y dónde se entrega»

**GUION LITERAL (consigna):**
> “Pasamos al **TALLER**. Tienen **17 minutos** y cuatro pasos. Todo lo de hoy queda en `S07_AjustesCierre_Apellido` —Google Doc o PDF— y **se guarda en su Drive**: la ACA Final ya cerró la semana pasada, así que hoy no se sube ningún archivo al aula.”
...
#### 6️⃣ Autoevaluación · Coevaluación en el aula (~8 min) — Protagonistas: Estudiantes + Docente
> **Replaneación de hoy (la hora no crece):** la fase de evaluación toma **8 min** y por eso se recortan: Taller: sustentación cruzada y consolidación 25→17 min. Donde la consigna del taller diga otra cantidad de minutos, manda el plan de clase.
...
#### 7️⃣ Cierre del curso (~8 min) — Protagonista: Docente
**Slides del deck:** **18–22** · «Qué hacer con esta propuesta después del curso» → «Cierre del curso · últimos pendientes» → «Cierre — Sesión 07»
...
- [ ] Abrí `Clases/Sesion 07 - Taller de consolidación y sustentación de la propuesta/Presentacion.pptx`
...
---
*Fin del Guión — Sesión 07. Cierra el ciclo de encuentros del Syllabus EI004: sin contenido nuevo, sin entrega nueva y con la propuesta sostenida en voz alta.*
