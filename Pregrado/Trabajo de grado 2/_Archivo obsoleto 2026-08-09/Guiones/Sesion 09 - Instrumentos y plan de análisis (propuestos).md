### GUIÓN DOCENTE — Sesión 09: Instrumentos y plan de análisis (propuestos)
...
> **PPTX:** `Clases/Sesion 09 - Instrumentos y plan de análisis (propuestos)/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **09** · **Tema:** Instrumentos y plan de análisis (propuestos)
- **Detalle:** 12/10 clase autónoma (festivo).
- **PPTX estudiante:** `Clases/Sesion 09 - Instrumentos y plan de análisis (propuestos)/Presentacion.pptx`
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **09**: *Instrumentos y plan de análisis (propuestos)*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** 10 ítems o guía de 8 preguntas.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Bosquejo de instrumento + plan. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Instrumentos y plan de análisis (propuestos)*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S09_Instrumentos_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Bosquejo de instrumento + plan.
2. Archivo en CDigital: `S09_Instrumentos_Apellido`.
