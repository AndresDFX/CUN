### GUIÓN DOCENTE — Sesión 05: Fase I de referentes de investigación
...
> **PPTX:** `Clases/Sesion 05 - Fase I de referentes de investigación/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **05** · **Tema:** Fase I de referentes de investigación
- **Detalle:** Diálogo colaborativo.
- **PPTX estudiante:** `Clases/Sesion 05 - Fase I de referentes de investigación/Presentacion.pptx`
...
1. **Desarrollar:** Fase I de referentes.
...
#### Enfoque
Fase I de referentes: fichas y mapa de literatura.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **05**: *Fase I de referentes de investigación*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Mínimo de referentes de calidad con vínculo al problema. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Fase I de referentes de investigación*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S05_Avance_Apellido` en CDigital.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Mínimo de referentes de calidad con vínculo al problema.
2. Archivo en CDigital: `S05_Avance_Apellido` en CDigital.
