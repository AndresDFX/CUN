### GUIÓN DOCENTE — Sesión 11: Socialización de avances
...
> **PPTX:** `Clases/Sesion 11 - Socialización de avances/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **11** · **Tema:** Socialización de avances
- **Detalle:** Retroalimentación entre pares/docente.
- **PPTX estudiante:** `Clases/Sesion 11 - Socialización de avances/Presentacion.pptx`
...
Pitch de 3 minutos + 3 comentarios de pares con criterio.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **11**: *Socialización de avances*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Cronómetro en pantalla.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Guion de socialización + notas de feedback. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Socialización de avances*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S11_Socializacion_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Guion de socialización + notas de feedback.
2. Archivo en CDigital: `S11_Socializacion_Apellido`.
