...
7. `Docente/Guiones/Sesion 02 - ….md` — guion docente, para confirmar qué se dijo en voz alta sobre MinCiencias y el SNCTI.
...
python config/moodle/cdigital.py importar "Pregrado/Investigacion en ciencia y tecnologia/Docente/Cuestionarios/Parcial 1 - banco de preguntas (Moodle XML).xml" --curso 111070
