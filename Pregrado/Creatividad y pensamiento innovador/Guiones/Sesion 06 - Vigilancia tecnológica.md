### GUIÓN DOCENTE — Sesión 06: Vigilancia tecnológica
...
> **PPTX:** `Clases/Sesion 06 - Vigilancia tecnológica/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **06** · **Tema:** Vigilancia tecnológica
...
**GUION LITERAL:**
> “Buenas tardes. **Sesión 06**: **Vigilancia tecnológica**. La sesión pasada probaron su MVP con usuarios. Hoy levantamos la vista del prototipo y miramos el **entorno**: ¿qué tecnología, qué competidor, qué norma afecta su propuesta? La idea es que su MVP no viva en una burbuja.”
...
![Docs — matriz de vigilancia](Capturas/s01_google_docs_inicio.png)
...
![Scholar en otra pestaña + matriz](Capturas/s01_google_docs_inicio.png)
...
---
*Fin del Guión — Sesión 06. Documento autocontenido: un docente sin trayectoria en innovación puede estudiarlo y dictar la hora completa.*
