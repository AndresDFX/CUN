### GUIÓN DOCENTE — Sesión 03: Pregunta, objetivos y título provisional
...
> **PPTX:** `Clases/Sesion 03 - Pregunta, objetivos y título provisional/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **03** · **Tema:** Pregunta, objetivos y título provisional
- **Detalle:** 17/08 es clase autónoma (festivo).
- **PPTX estudiante:** `Clases/Sesion 03 - Pregunta, objetivos y título provisional/Presentacion.pptx`
...
Título ≤21 palabras orientativo; objetivos con verbos precisos; pregunta alineada.

#### Práctica
Solo herramientas gratis en la nube (Docs, Scholar, ZoteroBib, Excalidraw).

#### Ejemplo modelo para clase
Corregir verbos ‘conocer/entender’.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **03**: *Pregunta, objetivos y título provisional*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Corregir verbos ‘conocer/entender’.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Bloque pregunta + general + 3 específicos + título. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Pregunta, objetivos y título provisional*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S03_PreguntaObjetivos_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Bloque pregunta + general + 3 específicos + título.
2. Archivo en CDigital: `S03_PreguntaObjetivos_Apellido`.
