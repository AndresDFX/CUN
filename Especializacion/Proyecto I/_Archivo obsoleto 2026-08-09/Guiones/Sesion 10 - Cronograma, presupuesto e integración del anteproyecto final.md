### GUIÓN DOCENTE — Sesión 10: Cronograma, presupuesto e integración del anteproyecto final
...
> **Duración bloque de contenido:** ≈ 60 min.
> **PPTX:** `Clases/Sesion 10 - Cronograma, presupuesto e integración del anteproyecto final/Presentacion.pptx` (referencia solo estas slides).

📌 **De esta sesión**
- **Sesión:** **10** · **Tema:** Cronograma, presupuesto e integración del anteproyecto final
- **Detalle:** Última sesión sincrónica antes del cierre ACA3 (08/11).
- **PPTX estudiante:** `Clases/Sesion 10 - Cronograma, presupuesto e integración del anteproyecto final/Presentacion.pptx`
...
| Slide | Título | Cuándo |
| :---: | :--- | :--- |
| **1** | Portada — 10 | Apertura |
| **2** | OBJETIVOS | Encuadre |
| **3** | CONTENIDO CLAVE | Exposición |
| **4** | RECUERDA | Anclaje del tema |
...
|---|---|---|---|
| Encuadre | 8 | Bienvenida, objetivos, Meet; recuerda tutorías (https://forms.gle/oZ8xCYiUo3KEWr1d9). | 1–2 |
| Exposición | 25 | Explica el tema con diapositivas; modela 1 ejemplo en vivo. | 3–4 |
| Taller | 20 | Equipos aplican el concepto a su anteproyecto; circula y pregunta. | 5 |
| Cierre contenido | 7 | Resume 3 ideas clave + tarea hasta la próxima. | 6–7 |
| Tutoría (2ª hora) | 60 | Revisión por equipo; cada estudiante registra asistencia. | — |


**Script de apertura (ejemplo):**
> “Buenas tardes. Sesión 10: *Cronograma, presupuesto e integración del anteproyecto final*. Al terminar deben salir con un avance
...
3. **Entregable:** avance en CDigital / plantilla APA CUN según corresponda.

---

✅ **Checklist del docente antes de clase**
- [ ] Leí el fundamento teórico de arriba
- [ ] Tengo la presentación `Clases/Sesion 10 - Cronograma, presupuesto e integración del anteproyecto final/Presentacion.pptx`
- [ ] Publiqué materiales en CDigital
