...
- **Modelo de calidad:** `Pregrado/Creatividad y pensamiento innovador/Guiones/Sesion 01 - Presentación del curso · docente · estudiantes · ACAs.md` *(la versión anterior dejó de existir con el renombrado del 2026-08-09; está archivada como `_Archivo obsoleto 2026-08-09/Guiones/Sesion 01 - Introducción · Propuesta de Innovación (trabajo final).md` — la ruta que citaba antes este LEEME, «… creatividad e inteligencia em.md», no existe ni siquiera en el archivo)*
