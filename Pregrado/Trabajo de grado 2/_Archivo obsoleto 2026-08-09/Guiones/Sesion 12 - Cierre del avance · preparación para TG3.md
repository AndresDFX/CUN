### GUIÓN DOCENTE — Sesión 12: Cierre del avance · preparación para TG3
...
> **PPTX:** `Clases/Sesion 12 - Cierre del avance · preparación para TG3/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **12** · **Tema:** Cierre del avance · preparación para TG3
- **Detalle:** 02/11 y 16/11 clases autónomas (festivos).
- **PPTX estudiante:** `Clases/Sesion 12 - Cierre del avance · preparación para TG3/Presentacion.pptx`
...
Checklist de cierre + pendientes explícitos para TG3.

#### Práctica
Solo herramientas gratis en la nube (Docs, Scholar, ZoteroBib, Excalidraw).

#### Ejemplo modelo para clase
Qué sí quedó listo vs qué queda para ejecución/artículo final.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **12**: *Cierre del avance · preparación para TG3*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Qué sí quedó listo vs qué queda para ejecución/artículo final.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Lista de pendientes TG3 + versión limpia del avance. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Cierre del avance · preparación para TG3*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S12_CierreTG2_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Lista de pendientes TG3 + versión limpia del avance.
2. Archivo en CDigital: `S12_CierreTG2_Apellido`.
