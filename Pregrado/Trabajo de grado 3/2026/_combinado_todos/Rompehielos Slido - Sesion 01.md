# Rompehielos de la Sesión 01 — TRABAJO DE GRADO 3

**Grupo(s):** 54450 + 54466 + 54467 · **112 matriculados**
...
> `Clases/`. Regenerar: `python config/slides/build_rompehielos_slido.py tg3`
...
Con 112 estudiantes, pedir que se presenten uno por uno no cabe en la hora, y un muro
...
5. Deja el **Q&A abierto** toda la sesión. En el plan gratis es ilimitado y, con 112
   matriculados, es donde de verdad van a preguntar: por micrófono no lo hará casi nadie.

El plan gratis de Slido admite **100 participantes por evento**. Hay 112 matriculados, así que si algún día se conectaran más de 100 a la vez, los últimos se quedarían fuera del juego (no de la clase). A una virtual de una hora no se conecta la matrícula completa, pero conviene saberlo. Vas a usar 1 encuesta de las 3 gratis y el único quiz; quedan dos de reserva.
...
tres, no 112. Y hablan los que ya se ganaron el turno, no los de siempre.
...
> **Revisión 1 a 1 con el Docente** del avance del ganador, antes de Quiz 1 (25/08/2026). Media hora
...
Con 112 matriculados no llega todo el mundo a la sincrónica. Deja el evento
