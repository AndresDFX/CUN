# Docente — Creatividad y Pensamiento Innovador

**EI004 · grupo 54408** · aula CDigital **115463**
...
`Guiones/` — los **guiones docentes**, uno por sesión (`Sesion NN - <tema>.md`, 7 en este curso) y
...
`_regen_guiones_creatividad.py` (o `config/slides/build_sesion_material.py <curso> all
--guion-only`).
...
python config/moodle/cdigital.py importar \
  "Pregrado/Creatividad y pensamiento innovador/Docente/Cuestionarios/Parcial 1 - banco de preguntas (Moodle XML).xml" \
  --curso 115463 --simular
```
