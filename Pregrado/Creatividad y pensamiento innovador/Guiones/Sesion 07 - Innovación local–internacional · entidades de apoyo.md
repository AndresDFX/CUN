### GUIÓN DOCENTE — Sesión 07: Innovación local–internacional · entidades de apoyo
...
> **PPTX:** `Clases/Sesion 07 - Innovación local–internacional · entidades de apoyo/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **07** · **Tema:** Innovación local–internacional · entidades de apoyo
...
**GUION LITERAL:**
> “Buenas tardes. Esta es la **última sesión sincrónica** del curso — **Sesión 07**: **Innovación local–internacional y entidades de apoyo**. Hoy conectamos su propuesta con el **afuera**: quién podría ayudarles a que esto no se quede en un archivo, y cómo lo cuentan en 60 segundos.”
...
![Pitch 60 s — guion](Capturas/s01_excalidraw_pizarra.png)
...
---
*Fin del Guión — Sesión 07. Cierra el ciclo de encuentros del Syllabus EI004.*
