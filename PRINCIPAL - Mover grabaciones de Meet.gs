...
var DESTINO_ID = 'https://drive.google.com/drive/folders/1TPGCeqIsaCQsh4-n5sniy68EnE7HYOal?usp=sharing';
...
//   «Proyecto I»   (el nombre lo decide CARPETA_MATERIA_CON_PERIODO, aquí debajo)
...
//            OMISIÓN, y no por gusto: el Docente ya creó a mano las carpetas de
//            sus cinco asignaturas con ese nombre, y manda lo que él hizo.
...
//   true  -> «26ES4 - 54ES4 - Proyecto I»
//            Una carpeta por periodo y grupo: separa los semestres, a cambio de multiplicar
//            las carpetas y de no coincidir con las que ya estén creadas a mano.
...
//   «[periodo - ]grupo(s) - Asignatura - Sesion NN»   (sesiones_cun.subject_encuentro; el periodo es opcional: Proyecto I y Creatividad no lo llevan. Los códigos van con «/» o con espacio: Drive no admite la barra y Meet la cambia por un espacio)
 ...
 * Canónico = «[periodo - ]grupo(s) - Asignatura - Sesion NN» (sesiones_cun.subject_encuentro; el periodo es opcional: Proyecto I y Creatividad no lo llevan. Los códigos van con «/» o con espacio: Drive no admite la barra y Meet la cambia por un espacio).
 */
