### GUIÓN DOCENTE — Sesión 06: Socialización del artículo y cierre del curso

> **Uso:** guion de locución de la sesión de **cierre**. Hoy **no se dicta contenido nuevo**: se socializa el artículo, se retroalimenta entre pares y se diligencian **autoevaluación** y **coevaluación**, que abren hoy.
...
> **PPTX:** `Clases/Sesion 06 - Socialización del artículo y cierre del curso/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **06** · **Tema:** Socialización del artículo y cierre del curso
...
- **PPTX estudiante:** `Clases/Sesion 06 - Socialización del artículo y cierre del curso/Presentacion.pptx`
...
| **Quiz 3** | Cuestionario | 3 | 4% | **Ya cerró** — hoy toca devolución y registro de la nota |
...
> “**Quiz 3** ya cerró. La nota queda en el libro de calificaciones del aula y hoy les devuelvo lo importante: dónde se equivocó el grupo y qué no se puede repetir en la entrega que cierra el curso. Lo que revisamos aquí no cambia la nota; evita que se repita.”
...
| :---: | :--- |
| **1** | SESIÓN 06 — Socialización del artículo y cierre del curso |
| **2** | El artículo ya se entregó: hoy se sostiene en voz alta |
| **3** | El artículo ya se entregó: hoy se sostiene en voz alta (cont.) |
| **4** | De dónde vienen: seis semanas en una línea |
| **5** | Trazabilidad: qué sesión produjo qué sección del artículo |
| **6** | Cómo se socializa un artículo en cuatro minutos |
...
| **11** | TALLER · Ronda de socialización (~25 min) |
...
| **14** | Autoevaluarse con criterio: cuatro preguntas honestas |
| **15** | Qué le falta a su artículo para ser publicable |
| **16** | Del artículo al semillero y al trabajo de grado |
| **17** | Preguntas del último día |
| **18** | Preguntas del último día (cont.) |
...
1. **Sostener** el artículo en voz alta en **cuatro minutos**: contexto y problema, pregunta literal, hallazgos del marco, qué está listo y qué falta.
...
| “Muy bien, felicitaciones” como coevaluación. | Eso no es retroalimentar. Exija las tres frases: me quedó claro / no me quedó claro / le sugiero. |
| “Mi pregunta cambió después de entregar.” | Es buena señal: la evidencia le enseñó algo. Se anota y se lleva a la siguiente versión del documento. |
| “¿Puedo entregar el artículo por correo?” | No. La entrega oficial era CDigital y su espacio ya cerró; cualquier situación particular se habla por el canal del curso antes del cierre de notas. |
| “¿Sirve este artículo para otra materia?” | Como base sí, y conviene declararlo. Volver a entregar el mismo texto como nuevo es autoplagio. |
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre: qué pasa hoy y de dónde vienen | 6 | min 00:00 – 06:00 |
| 2️⃣ Cómo se socializa en cuatro minutos y qué le van a preguntar | 8 | min 06:00 – 14:00 |
| 3️⃣ Modelación: las tres frases y la rúbrica de la ronda | 8 | min 14:00 – 22:00 |
| 4️⃣ TALLER: ronda de socialización | 22 | min 22:00 – 44:00 |
| 5️⃣ Autoevaluación · Coevaluación en el aula | 8 | min 44:00 – 52:00 |
| 6️⃣ Cierre: ruta del artículo y despedida | 8 | min 52:00 – 60:00 |

> **Suma:** **60 minutos** exactos.

---

#### 1️⃣ Encuadre: qué pasa hoy y de dónde vienen (~6 min) — Portada · «El artículo ya se entregó» · «Seis semanas en una línea» · «Trazabilidad»
...
#### 2️⃣ Cómo se socializa en cuatro minutos y qué le van a preguntar (~8 min) — «Cómo se socializa un artículo en cuatro minutos» → «Las cinco preguntas que le van a hacer»
**Protagonista:** Docente (exposición corta).
...
#### 3️⃣ Modelación: las tres frases y la rúbrica de la ronda (~8 min) — «Retroalimentar bien: la fórmula de las tres frases» → «Rúbrica de la ronda»
**Protagonista:** Docente (modela una devolución).
...
#### 4️⃣ TALLER: ronda de socialización (~22 min) — «TALLER · Ronda de socialización»
**Protagonista:** Estudiantes (ronda) · Docente cronometra y modera.

**Momento del deck:** «TALLER · Ronda de socialización»

**GUION LITERAL (consigna):**
> “**Ronda de socialización: 22 minutos.** Cuatro pasos y yo llevo el reloj en voz alta.”
...
> **Replaneación de hoy (la hora no crece):** la fase de evaluación toma **8 min** y por eso se recortan: TALLER: ronda de socialización 30→22 min. Donde la consigna del taller diga otra cantidad de minutos, manda el plan de clase.
...
#### 6️⃣ Cierre: ruta del artículo y despedida (~8 min) — «Qué le falta para ser publicable» → «Del artículo al semillero» → «Preguntas del último día» → Cierre
**Protagonista:** Docente.
...
- [ ] Nota de **Quiz 3** (4%) revisada en el libro de calificaciones antes de entrar: hoy se devuelve
