### GUIÓN DOCENTE — Sesión 08: Diseño metodológico (propuesto)
...
> **PPTX:** `Clases/Sesion 08 - Diseño metodológico (propuesto)/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **08** · **Tema:** Diseño metodológico (propuesto)
- **Detalle:** Enfoque, tipo, alcance.
- **PPTX estudiante:** `Clases/Sesion 08 - Diseño metodológico (propuesto)/Presentacion.pptx`
...
Enfoque/alcance/diseño alineados; aún propuesto si no hay campo en este punto.

#### Práctica
Solo herramientas gratis en la nube (Docs, Scholar, ZoteroBib, Excalidraw).

#### Ejemplo modelo para clase
Matriz pregunta–método.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **08**: *Diseño metodológico (propuesto)*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Matriz pregunta–método.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Ficha metodológica. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Diseño metodológico (propuesto)*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S08_Metodologia_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Ficha metodológica.
2. Archivo en CDigital: `S08_Metodologia_Apellido`.
