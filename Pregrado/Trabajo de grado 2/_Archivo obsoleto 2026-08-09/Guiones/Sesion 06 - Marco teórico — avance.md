### GUIÓN DOCENTE — Sesión 06: Marco teórico — avance
...
> **PPTX:** `Clases/Sesion 06 - Marco teórico — avance/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **06** · **Tema:** Marco teórico — avance
- **Detalle:** Variables y bases teóricas.
- **PPTX estudiante:** `Clases/Sesion 06 - Marco teórico — avance/Presentacion.pptx`
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **06**: *Marco teórico — avance*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** 3 constructos máximos bien hilados.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Mapa de constructos + 1–2 páginas. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Marco teórico — avance*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S06_MarcoTeorico_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Mapa de constructos + 1–2 páginas.
2. Archivo en CDigital: `S06_MarcoTeorico_Apellido`.
