...
| **18** | TALLER · Ideación sobre su propio problema |
| **19** | TALLER · cómo se revisa y dónde se entrega |
| **20** | Antes de entregar: revise usted mismo |
...
![Miro — Design Thinking (plantilla free)](Capturas/Sesion 01/s01_miro_design_thinking.png)

> **En pantalla:** Mostrar etapas DT; plan B: Excalidraw si Miro pide login.

![Excalidraw — HMW + banco de ideas](Capturas/s01_excalidraw_pizarra.png)
...
![IDEO Design Kit (referencia)](Capturas/Herramientas/dt_ideo_designkit.png)
