### GUIÓN DOCENTE — Sesión 09: Devolución de la ACA 1 · población, muestra e instrumentos propuestos
...
📌 **De esta sesión**
- **Sesión:** **09** · **Tema:** Devolución de la ACA 1 · población, muestra e instrumentos propuestos
...
- **PPTX estudiante:** `Clases/Sesion 09 - Devolución de la ACA 1 · población, muestra e instrumentos propuestos/Presentacion.pptx`
...
> **Abierto todo el periodo (hoy no cierra):** **ACA FINAL** (Tarea · 42% · corte 3). Es el producto acumulativo: cada sesión le agrega una sección, así que el avance de hoy es parte de esa entrega.
...
| :---: | :--- |
| **1** | SESIÓN 09 — Devolución de la ACA 1 · población, muestra e instrumentos propuestos |
| **2** | Primeros 20 minutos: la devolución de la ACA 1 |
| **3** | Cómo se lee la rúbrica de la ACA 1, criterio por criterio |
| **4** | Qué hacer con las correcciones antes de la ACA FINAL |
| **5** | La regla de oro de hoy: nadie manda todavía ese formulario |
| **6** | Antes de la muestra: ¿cuál es su unidad de análisis? |
| **7** | Población, muestra y muestreo: tres cosas distintas |
| **8** | Criterios de inclusión y exclusión: sin ellos, la muestra es un deseo |
| **9** | Tipos de muestreo: probabilístico y no probabilístico |
| **10** | ¿De qué tamaño debe ser la muestra? |
| **11** | Técnica e instrumento no son sinónimos |
| **12** | De la técnica al instrumento: qué produce cada ruta |
| **13** | Las cuatro declaraciones obligatorias de todo instrumento propuesto |
| **14** | Matriz de alineación: cada ítem cuelga de un objetivo |
| **15** | Ejemplo modelado: ítems reales de los dos tipos de instrumento |
| **16** | Ética y datos: lo que su instrumento debe prever desde ya |
| **17** | Ética y datos: lo que su instrumento debe prever desde ya (cont.) |
| **18** | Paso a paso para bosquejar su instrumento en Google Docs |
| **19** | TALLER · Bosquejo de instrumento (20 minutos) |
...
#### 1. La clase abre con la devolución de la ACA 1 (20 min, no 5)
...
La slide RECUERDA y el Manual son claros: en Proyecto I los instrumentos son PROPUESTOS. En la tutoría, el estudiante diligencia su formulario de asistencia: https://forms.gle/oZ8xCYiUo3KEWr1d9.
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre + devolución de la ACA 1 | 20 | min 00:00 – 20:00 |
| 2️⃣ Regla de oro P-I + población, muestra y muestreo | 8 | min 20:00 – 28:00 |
| 3️⃣ Técnica, instrumento y alineación a objetivos | 8 | min 28:00 – 36:00 |
| 4️⃣ Taller: bosquejo de instrumento | 20 | min 36:00 – 56:00 |
| 5️⃣ Cierre | 4 | min 56:00 – 60:00 |
...
#### 1️⃣ Encuadre + devolución de la ACA 1 (~20 min) — Protagonista: Docente
**Momento del deck:** Portada → Primeros 20 minutos: la devolución de la ACA 1 → Cómo se lee la rúbrica, criterio por criterio → Qué hacer con las correcciones antes de la ACA FINAL
...
**Momento del deck:** La regla de oro de hoy → Unidad de análisis → Población, muestra y muestreo → Inclusión y exclusión → Tipos de muestreo → Tamaño de la muestra
...
**Momento del deck:** Técnica e instrumento no son sinónimos → De la técnica al instrumento → Las cuatro declaraciones → Matriz de alineación → Ejemplo modelado → Ética y datos → Paso a paso en Google Docs
...
**Momento del deck:** TALLER · Bosquejo de instrumento
...
**Momento del deck:** Checklist de autoevaluación → Trabajo autónomo y qué viene después → Cierre
...
**Foco de hoy en tutoría:** resolver dudas de los comentarios de la ACA 1; revisar instrumentos y frenar cualquier aplicación prematura.
...
---
*Fin del Guión — Sesión 09. Autocontenido para dictar 60+60.*
