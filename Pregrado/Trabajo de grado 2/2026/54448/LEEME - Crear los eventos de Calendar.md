...
1. Descarga otra vez el listado del aula y sobrescribe `2026/54448/Listado estudiantes (CDigital).csv`.
2. `python config/slides/build_calendar_encuentros.py tg2` — el `.gs` sale con el roster nuevo dentro.
...
| 03 | 31/08/2026 (lunes) | Estructura del documento de avance | 50 |
