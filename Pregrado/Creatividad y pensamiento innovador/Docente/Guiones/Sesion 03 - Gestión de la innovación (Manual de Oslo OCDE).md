### GUIÓN DOCENTE — Sesión 03: Gestión de la innovación (Manual de Oslo / OCDE)
...
> **PPTX:** `Clases/Sesion 03 - Gestión de la innovación (Manual de Oslo OCDE)/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **03** · **Tema:** Gestión de la innovación (Manual de Oslo / OCDE)
...
| **17** | TALLER · Ficha Oslo de su propuesta |
...
**GUION LITERAL:**
> “Buenas tardes. **Sesión 03**: **Gestión de la innovación con el Manual de Oslo**. La sesión pasada eligieron una o dos ideas para su propuesta. Hoy hacemos dos cosas: le ponemos **nombre** a esa innovación con el idioma de Oslo y le ponemos **gestión mínima** —quién hace qué esta semana—.”
...
![Docs — tabla Oslo](Capturas/s01_google_docs_inicio.png)
...
![Excalidraw — ficha Oslo de su propuesta](Capturas/s01_excalidraw_pizarra.png)
...
---
*Fin del Guión — Sesión 03. Documento autocontenido: un docente sin trayectoria en innovación puede estudiarlo y dictar la hora completa.*
