# Índice y agenda de sustentaciones — Especialización en Transformación Digital · 26ET2

**Mi rol:** Jurado 2 · Julián Andrés Castaño Espinosa (julian_castanoe@cun.edu.co)
**Panel:** María Fernanda Rivera Sanclemente (directora / moderadora, maria_riveras@cun.edu.co) · Hayder Alejandro Romero Sierra (Jurado 1, hayder_romeros@cun.edu.co) · yo (Jurado 2)
...
## 1. LA AGENDA — para tener abierta durante la sesión

### MARTES 18 DE AGOSTO · 6:00 p. m. – 9:00 p. m.

| Horario | Código | Título corto | Integr. | Entregables |
|---|---|---|:-:|---|
| 6:00 – 6:20 | **G-001** | TuFinca: módulo pecuario y chatbot (Anzoátegui, Tolima) | 3 | 273 p. + 17 diap. |
| 6:20 – 6:40 | **G-002** | PWA turística de Rivera (Huila) con chat inteligente | 3 | 86 p. + 16 diap. |
| 6:40 – 7:00 | **G-003** | Archivo municipal de San Francisco (Putumayo) | 4 | 169 p. + 10 diap. |
| 7:00 – 7:20 | **G-004** | Gestión del cambio en seguridad electrónica | 2 | 140 p. + 32 diap. |
| 7:20 – 7:40 | **G-005** | Predicción de fallas SCADA-OMS-GIS en CENS | 2 | 115 p. + 15 diap. |
| 7:40 – 8:00 | **G-006** | Sistema web de licitaciones (Agroindustrial de Palma) | 3 | 249 p. + 16 diap. |
| 8:00 – 8:20 | **G-007** | Modelo de diagnóstico de madurez digital en pymes | 2 | 94 p. + 19 diap. |
| 8:20 – 8:40 | **G-008** | Modelo conceptual de energía solar rural (Valle del Cauca) | 3 | 129 p. + 12 diap. |
...
> **Turno de riesgo:** último grupo del día, detrás de ocho. Si la jornada acumula retraso, ir con las preguntas 1 y 3 solamente.

### MIÉRCOLES 19 DE AGOSTO · 6:00 p. m. – 7:20 p. m.

| Horario | Código | Título corto | Integr. | Entregables |
|---|---|---|:-:|---|
| 6:00 – 6:20 | **G-010** | Plataforma de preparación para concursos DIAN | 2 | 78 p. · **sin presentación** |
| 6:20 – 6:40 | **G-011** | Intranet CDS para atención al cliente | 1 | **sin documentos** |
| 6:40 – 7:00 | **G-012** | Simulador de asignación de pauta digital | 4 | 71 p. + 19 diap. |
...
> Trabajo individual y cierre de la jornada: acordar antes con la Dirección el reparto (yo tomo el objetivo 3 y la muestra) para no repetir preguntas.

---

## 2. LA TABLA COMPARATIVA — para leer antes del martes

| # | Grupo | Título corto | Línea (cronograma) | Integr. | Páginas | Objetivos | Veredicto en una línea | Rango anticipado (§7) |
|:-:|---|---|---|:-:|:-:|---|---|---|
| 1 | **G-001** | TuFinca: módulo pecuario y chatbot | Liderazgo y Adaptación con Tecnologías Emergentes | 3 | 273 + 17 diap. | **4/4** (OE4 con salvedad en el «antes») | Los cuatro objetivos cierran con medición real y conteos crudos verificables (pp. 209-213); los huecos son el motor conversacional sin tecnología nombrada (p. 171) y la ausencia total de costeo | **4,6–4,8**; 5,0 solo con sostenibilidad cuantificada |
| 2 | **G-002** | PWA turística de Rivera (Huila) | Gestión y Tecnología (portada en blanco) | 3 | 86 + 16 diap. | 2/4 · OE3 parcial · **OE4 no ejecutado** | PWA pública y verificada (p. 74), pero el chat aparece en dos estados contradictorios (folios 68 y 71) y el objetivo 4 quedó formulado sin aplicar (Tabla 23) | **4,0–4,5**; 4,6+ solo con el chat en vivo |
| 3 | **G-003** | Archivo municipal de San Francisco | Gestión y Tecnología | **4** | 169 + 10 diap. | 1/4 pleno · 2 parciales · **OE4 no en el entorno prometido** | Diagnóstico sólido (1,9/5, pp. 79-84) y prototipo probado en laboratorio; el alcance de la p. 27 afirma en pasado un despliegue que el resto del documento desmiente | **4,0–4,4** |
| 4 | **G-004** | Gestión del cambio en seguridad electrónica | Ingeniería y Tecnología | 2 | 140 + 32 diap. | 3/4 · **OE3 con dos resultados incompatibles** | Trabajo bien estructurado, con inventario documental real y estrategia de sostenibilidad, atravesado por dos modelos que se contradicen sobre el mismo objetivo (pp. 98-99 frente a 101-102) | **4,0–4,5** |
| 5 | **G-005** | Predicción de fallas SCADA-OMS-GIS | Gestión y Tecnología | 2 | 115 + 15 diap. | 4/4 · **metas propias no alcanzadas** · H1 sin contrastar | Comparación de modelos bien ejecutada, sobre datos sintéticos que el documento declara (p. 14) y las diapositivas no; AUC 0,616 frente a la meta de 0,75 (pp. 28, 97) y ni una captura del tablero | **4,0–4,4** |
| 6 | **G-006** | Sistema web de licitaciones | Gestión y Tecnologías | 3 | 249 + 16 diap. | 3/4 · **OE4 parcial** | Producto en producción desde el 1/6/2026 (p. 181) con ingeniería documentada; el impacto se midió con ADKAR y no con el instrumento de madurez prometido (pp. 76, 235), y hay 32 horas posiblemente contadas dos veces (p. 233) | **4,2–4,6** |
| 7 | **G-007** | Diagnóstico de madurez digital en pymes | Ingeniería y Tecnología | 2 | 94 + 19 diap. | 1/4 pleno · 2 parciales · **OE4 no verificable** | Campo real con 30 empresas e instrumento propio de 10 dimensiones, pero la correlación se reporta como «001» (p. 84), hay dos distribuciones incompatibles (pp. 79-80) y la competitividad se asigna desde la madurez (p. 78) | **4,0–4,4** |
| 8 | **G-008** | Modelo conceptual de energía solar rural | Desarrollo de soluciones técnicas aplicadas | 3 | 129 + 12 diap. | 3/4 · **OE1 parcial** | Modelo conceptual coherente con su verbo «proponer» y descriptible (pp. 102-116); el anclaje al Valle del Cauca no tiene evidencia en el corpus (pp. 43-48) y el mazo contradice al documento en corpus y porcentajes | **4,0–4,4**; laureada, no |
| 9 | **G-009** | Ecosistema digital de RR. HH. | Arquitectura y estrategias para la TD en las organizaciones (portada: Gestión y Tecnología) | 2 | 126 + 23 diap. | 4/4 en nivel de diseño · OE3 parcial | Techo declarado y techo alcanzado coinciden (pp. 22, 103-104) y el campo es real; frena que los 16 indicadores no tengan línea base numérica (pp. 93-97) y que el OE2 se contradiga (p. 48 frente a p. 88) | **4,0–4,4**; meritoria alcanzable |
| 10 | **G-010** | Plataforma para concursos DIAN | Gestión y Tecnologías | 2 | 78 · **sin diap.** | 2/4 · OE2 parcial · **OE4 no como impacto** | Marco normativo y limitaciones bien hechos, pero el documento trae dos juegos de objetivos, dos arquitecturas y dos muestras (10 frente a 100), y no hay presentación que comparar | **3,4–3,9** (hasta 4,0–4,3) |
| 11 | **G-011** | Intranet CDS | Gestión y Tecnologías | 1 | **0** | **No evaluable** | Sin ningún documento entregado no hay base probatoria para el criterio «coherencia del documento»: todo depende de lo que se escuche el miércoles | **3,6–4,5** si sustenta bien (ver advertencia de §7 de su ficha) |
| 12 | **G-012** | Simulador de pauta digital | Mejoramiento de procesos organizacionales | **4** | 71 + 19 diap. | 3/4 · OE4 parcial | Modelo formalizado con 12 ecuaciones y prototipo ejecutable (pp. 45, 47-48, 70), honesto en sus límites; le faltan un criterio de decisión que incorpore el riesgo y explicar por qué el óptimo siempre se va a la plataforma más barata | **4,3–4,6** |
| 13 | **G-013** | Tesorería de cooperativas de Bogotá | Transformación Digital e Innovación Organizacional | 1 | 85 + 16 diap. | 2/4 · **OE3 no acreditado** · OE4 parcial | Diagnóstico con instrumento aplicado y encuestas escaneadas (pp. 46-61, 77-85) y arquitectura diseñada; del prototipo solo existe un panel (p. 62) y la muestra se reporta de tres maneras distintas | **3,6–4,0** |

**Lecturas transversales que conviene tener en la cabeza el martes:**
- **Ningún grupo declara reporte de similitud (Turnitin) ni uso de IA generativa** en su documento. Es de los 13, no de uno: eso lo convierte en un asunto del programa y del metodólogo (15 % de la rúbrica del ACA 3), no en un hallazgo de jurado.
- El hueco recurrente es el **cuarto objetivo de «evaluar / validar / medir impacto»**: queda parcial o no ejecutado en G-002, G-003, G-006, G-007, G-010, G-012 y G-013. Ahí está casi siempre la mejor pregunta.
- Cuatro grupos tienen **producto verificable y documentado** (G-001 desplegado en Azure, G-002 con URL pública, G-006 en producción, G-012 con notebook ejecutable) y dos más dependen de lo que se vea en sala (G-005 y G-013 anuncian prototipo sin captura). Es el discriminador real de la jornada: pedir ver o describir el producto es la pregunta más económica en tiempo.
- **La directora / moderadora es también la directora o asesora metodológica de casi todos estos trabajos** (declarado en las portadas de G-002, G-004, G-006, G-007, G-008, G-009 y G-013). Es lo previsto en el esquema del programa; se anota solo por transparencia del acta y para medir el tono al comentar debilidades en público.
- El **rango anticipado no es una nota**: es la lectura a priori del documento. La nota la pongo en sala contra los umbrales de la §7 de cada ficha, y solo ahí.

---

## 3. BANDERAS ADMINISTRATIVAS — para escribirle a la Dirección antes del martes

> Bloque **estrictamente administrativo**: nada de esto baja la nota académica de nadie. Verificado por mí, uno por uno, contra la hoja `MARIA-ESPTD` del cronograma (vía el JSON de alistamiento), contra las carpetas reales de Drive el 15/08/2026 y contra el `Resumen instructivo - Proyecto I y II.md` (§4: **máximo 3 estudiantes** por equipo; trabajo individual **solo con autorización del docente, caso a caso**).
> **Destinatario de todo el bloque:** María Fernanda Rivera Sanclemente (maria_riveras@cun.edu.co), directora del programa y moderadora, con copia a Hayder Alejandro Romero Sierra (Jurado 1) en los puntos que afectan el acta. **Enviarlo el lunes 17,** para que las respuestas lleguen antes de las 6:00 p. m. del martes.

### B1. Equipos de más de 3 integrantes (regla: máximo 3)

| Grupo | Integrantes en el cronograma | Confirmado también en |
|---|:-:|---|
| **G-003** | **4** — José Javier Galvis Noguera, Eliana Naranjo Cortés, Cristian David Forero Álvarez, Gloria Nahtaly Florez Susa | la declaración de originalidad del documento lleva los cuatro nombres (p. 12) |
| **G-012** | **4** — Anderson Iván Ortiz Cifuentes, Lida Vannesa Acosta Varela, Jonathan Orlando Cifuentes Aldana, Carol Alejandra Parada Zárate | portada (p. 1) y firmas (pp. 8-9) |

**Qué preguntar:** «El instructivo de Proyecto I y II fija un máximo de 3 estudiantes por equipo. G-003 y G-012 están registrados con 4. ¿Hubo autorización expresa de la Dirección para estos dos equipos y cómo debe quedar consignado en el acta de sustentación?» **Añadir la consecuencia práctica:** con cuatro personas y 20 minutos, pido que la moderadora fije al inicio que expongan máximo dos y que las preguntas las respondan los otros dos. **Dejar dicho por escrito** que no lo estoy usando como criterio de calificación.

### B2. Grupos sin entregables en la carpeta de jurados

| Grupo | Estado verificado el 15/08/2026 | Qué falta |
|---|---|---|
| **G-011** | Carpeta `26ET2-G-011` **vacía: cero archivos**. Es la carpeta a la que apunta el hipervínculo de la fila 46 de la hoja `MARIA-ESPTD` | **Todo:** ni trabajo de grado ni presentación |
| **G-010** | Un único archivo: `ACA 3 - Proyecto Jenny Rivas_ José Puello.pdf` (78 p.) | **La presentación** |

**Qué preguntar por G-011, y es lo más urgente de este bloque:** «La carpeta de G-011 está vacía. ¿El documento se entregó en CUN Digital o al docente metodólogo y solo no llegó a la carpeta de jurados? Si se entregó, ¿pueden compartirlo antes del miércoles? Si no se entregó, necesito instrucción escrita de la Dirección sobre cómo procedemos, porque **sin documento no tengo base probatoria para calificar el criterio de coherencia documental** y no voy a poner ni a negar una nota en ese criterio en solitario.» Nota adicional: la celda de observaciones de ese grupo está en blanco, así que **es probable que la Dirección todavía no lo haya detectado**.
**Qué preguntar por G-010:** «No hay presentación en la carpeta. ¿Van a sustentar con diapositivas? Si sí, pídanselas hoy y súbanlas, porque diapositivas que los jurados no pudieron revisar no se pueden evaluar y calificaré contra el documento.»

### B3. Correos institucionales mal escritos en el cronograma

| Grupo | Persona | Correo en el cronograma | Problema | Acción |
|---|---|---|---|---|
| **G-011** | Flor Ángela Hernández González | `flor.hernandezg@con.edu.co` | **Dominio `con.edu.co` en lugar de `cun.edu.co`** | El más grave: si las citaciones y la solicitud de documentos se enviaron ahí, **es posible que la estudiante nunca las haya recibido** — lo que explicaría la carpeta vacía de B2. Pedir a la Dirección que verifique el correo real y **reenvíe la citación del miércoles** |
| **G-008** | Ana Fernanda Puentes Robles | `ana.puestesr@cun.edu.co` | Parece errata de `ana.puentesr` (Pu**es**tes por Pu**en**tes) | Confirmar antes de enviar retroalimentación o firmar actas |
| **G-002** | Jhon Alexander Osorio Fernández | `john.osoriof@cun.edu.co` | El nombre es «Jhon» y el correo dice «john» | Verificar: puede ser el alias real asignado por la institución. Solo confirmar antes de notificar |
| **G-010** | Jose David Puello Avilez | `Jose.Puello@cun.edu.co` | Mayúsculas iniciales, a diferencia del resto | Cosmético (el correo no distingue mayúsculas): **no requiere acción**, se anota para que nadie lo confunda con un error |

Los 28 correos restantes están bien formados y con dominio `@cun.edu.co`.

### B4. Correos que parecen intercambiados entre integrantes

**G-003 — cruce confirmado.** En el cronograma:

| Nombre registrado | Correo registrado | Correo que le correspondería |
|---|---|---|
| Eliana Naranjo Cortés | `Cristian.foreroa@cun.edu.co` | `eliana.naranjo@cun.edu.co` |
| Cristian David Forero Álvarez | `eliana.naranjo@cun.edu.co` | `Cristian.foreroa@cun.edu.co` |

**Qué avisar:** «En la fila de G-003 los correos de Eliana Naranjo Cortés y Cristian David Forero Álvarez están intercambiados entre sí. Corregirlo **antes** de enviar retroalimentación, notas o actas, porque hoy cada uno recibiría la información del otro.» Es el único cruce: revisé los 32 correos contra los nombres, token por token, y ningún otro grupo lo presenta.

### B5. Trabajos individuales — confirmar la autorización

**G-011** (Flor Ángela Hernández González) y **G-013** (Eliana Vianeth Gaitán Garzón) están registrados con **una sola estudiante**. El instructivo lo permite, pero **solo con autorización del docente, caso a caso** (§4). **Qué preguntar:** «¿Existe y está registrada la autorización de trabajo individual para G-011 y G-013?» No es criterio de nota: se pregunta para que el acta quede completa y para calibrar que el volumen entregado y la carga de la sustentación son de una persona.

### B6. Pendientes de forma que le corresponden al metodólogo, no al jurado

Se listan juntos porque en un solo correo se resuelven: **ninguno de los 13 documentos declara índice de similitud (Turnitin) ni uso de IA generativa**; hay **declaraciones de originalidad con el programa equivocado** («Especialización en Analítica de Datos») en G-005 (p. 16) y G-013 (p. 9, además fechada en 2025); **fechas de firma incoherentes** con la entrega en G-004, G-006, G-007 y G-010; **líneas de profundización discrepantes** entre portada y cronograma en G-002, G-006, G-009 y G-013; **el título del cronograma con erratas** en G-007 y distinto del documento en G-002; **posibles asuntos de datos personales de terceros** en G-006 (proveedores y estados financieros), G-007 (30 empresas con razón social y debilidades de ciberseguridad), G-010 (encuesta a 100 funcionarios sin evidencia de autorización) y G-013 (nombre manuscrito visible en un anexo). Cada uno está detallado con página en la §8 de la ficha del grupo.
...
Estas fichas las preparó una herramienta leyendo los documentos entregados por cada grupo; **la nota la pone el jurado humano en la sala** y **cada página citada es verificable** en el documento del grupo, una por una.

---

*Índice preparado por Julián Andrés Castaño Espinosa (Jurado 2) el 15 de agosto de 2026. Carpetas de Drive, número de integrantes y correos reverificados ese día contra la hoja `MARIA-ESPTD` del cronograma 26ET2 y contra el sistema de archivos.*
