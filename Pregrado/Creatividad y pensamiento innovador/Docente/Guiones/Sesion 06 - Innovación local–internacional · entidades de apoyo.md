### GUIÓN DOCENTE — Sesión 06: Innovación local–internacional · entidades de apoyo
...
> **PPTX:** `Clases/Sesion 06 - Innovación local–internacional · entidades de apoyo/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **06** · **Tema:** Innovación local–internacional · entidades de apoyo
...
- **PPTX estudiante:** `Clases/Sesion 06 - Innovación local–internacional · entidades de apoyo/Presentacion.pptx`
...
| :---: | :--- |
| **1** | SESIÓN 06 — Innovación local–internacional · entidades de apoyo |
| **2** | Una semilla buena no basta |
| **3** | Qué le puede dar el ecosistema (y qué no) |
| **4** | La misma innovación cambia de escala: local → internacional |
| **5** | Tipos de impacto: por qué le importa a un país |
| **6** | El mapa de entidades: cuatro cuadrantes |
| **7** | Aprender a preguntar el encaje |
| **8** | "Pedir apoyo" no es un pedido |
| **9** | Ejemplo modelado: mapa de entidades del caso del laboratorio |
| **10** | El pitch de 60 segundos: qué logra y qué no |
| **11** | El pitch de 60 segundos: qué logra y qué no (cont.) |
| **12** | Los cinco tramos del pitch de 60 segundos |
| **13** | Ejemplo modelado: el pitch completo, tramo por tramo |
| **14** | Ejemplo modelado: el pitch completo, tramo por tramo (cont.) |
| **15** | Errores frecuentes y respuestas |
| **16** | Errores frecuentes y respuestas (cont.) |
| **17** | Paso a paso: escribir y ensayar su pitch |
| **18** | Paso a paso: escribir y ensayar su pitch (cont.) |
| **19** | TALLER · Mapa de entidades + guion del pitch |
| **20** | TALLER · cómo se revisa y dónde se entrega |
| **21** | Antes de entregar: revise usted mismo |
| **22** | Antes de entregar: revise usted mismo (cont.) |
| **23** | Para continuar — la semana en que se cierra la ACA Final |
| **24** | Para continuar — la semana en que se cierra la ACA Final (cont.) |
| **25** | RUTA DE ENTREGABLES DEL CURSO |
| **26** | Cierre — Sesión 06 |
...
🎯 **Objetivos de la sesión** *(**U8** del Syllabus, adelantada una sesión)*
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre: la última antes del cierre de la ACA Final | 5 | min 00:00 – 05:00 |
| 2️⃣ Qué da el ecosistema · escalas · tipos de impacto | 9 | min 05:00 – 14:00 |
| 3️⃣ Mapa de entidades, encaje y pedido concreto | 9 | min 14:00 – 23:00 |
| 4️⃣ El pitch de 60 segundos: cinco tramos y ejemplo | 9 | min 23:00 – 32:00 |
| 5️⃣ Taller: mapa de entidades + guion del pitch | 12 | min 32:00 – 44:00 |
| 6️⃣ Quiz 3 en CDigital (se aplica en clase) | 10 | min 44:00 – 54:00 |
| 7️⃣ Cierre: la semana en que se cierra la ACA Final | 6 | min 54:00 – 60:00 |
...
**Slides del deck:** **1–2** · «SESIÓN 06 — Innovación local–internacional · entidades de apoyo» → «Una semilla buena no basta»
...
**Slides del deck:** **3–5** · «Qué le puede dar el ecosistema (y qué no)» → «La misma innovación cambia de escala: local → internacional» → «Tipos de impacto: por qué le importa a un país»
...
![Docs — mapa de entidades de apoyo](Capturas/s01_google_docs_inicio.png)

> **En pantalla:** Tres columnas: entidad (nombre verificado) · tipo de encaje · pedido concreto y acotado.

#### 3️⃣ Mapa de entidades, encaje y pedido concreto (~9 min) — Protagonista: Docente
**Slides del deck:** **6–9** · «El mapa de entidades: cuatro cuadrantes» → «Aprender a preguntar el encaje» → «"Pedir apoyo" no es un pedido» → «Ejemplo modelado: mapa de entidades del caso del laboratorio»
...
**Slides del deck:** **10–17** · «El pitch de 60 segundos: qué logra y qué no» → «Los cinco tramos del pitch de 60 segundos» → «Ejemplo modelado: el pitch completo, tramo por tramo» → «Paso a paso: escribir y ensayar su pitch»
...
![Excalidraw — los cinco tramos del pitch](Capturas/s01_excalidraw_pizarra.png)

> **En pantalla:** Un recuadro por tramo, una frase en cada uno. Cronómetro a la vista al ensayar.

#### 5️⃣ Taller: mapa de entidades + guion del pitch (~12 min) — Protagonista: Estudiantes
**Slides del deck:** **15–20** · «Errores frecuentes y respuestas» → «TALLER · Mapa de entidades + guion del pitch» → «TALLER · cómo se revisa y dónde se entrega»

**GUION LITERAL (consigna):**
> “Pasamos al **TALLER**. Tienen **12 minutos** y cinco pasos.”
...
#### 6️⃣ Quiz 3 en CDigital (se aplica en clase) (~10 min) — Protagonistas: Estudiantes + Docente
> **Replaneación de hoy (la hora no crece):** la fase de evaluación toma **10 min** y por eso se recortan: Taller: mapa de entidades + guion del pitch 22→12 min. Donde la consigna del taller diga otra cantidad de minutos, manda el plan de clase.
...
#### 7️⃣ Cierre: la semana en que se cierra la ACA Final (~6 min) — Protagonista: Docente
**Slides del deck:** **21–26** · «Antes de entregar: revise usted mismo» → «Para continuar — la semana en que se cierra la ACA Final» → «Cierre — Sesión 06»
...
- [ ] Abrí `Clases/Sesion 06 - Innovación local–internacional · entidades de apoyo/Presentacion.pptx`
...
---
*Fin del Guión — Sesión 06. Última sincrónica antes del cierre de la ACA Final. Documento autocontenido: un docente sin trayectoria en innovación puede estudiarlo y dictar la hora completa.*
