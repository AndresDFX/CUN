### GUIÓN DOCENTE — Sesión 05: Antecedentes y referentes (Fase I)
...
> **PPTX:** `Clases/Sesion 05 - Antecedentes y referentes (Fase I)/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **05** · **Tema:** Antecedentes y referentes (Fase I)
- **Detalle:** Búsqueda en bases CUN.
- **PPTX estudiante:** `Clases/Sesion 05 - Antecedentes y referentes (Fase I)/Presentacion.pptx`
...
1. **Lograr:** Construir antecedentes/referentes Fase I.
...
Fichas con vínculo a la pregunta; mixto nacional/internacional.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **05**: *Antecedentes y referentes (Fase I)*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Scholar + SciELO demo.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: 4 fichas mínimas + párrafo puente. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Antecedentes y referentes (Fase I)*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S05_Antecedentes_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. 4 fichas mínimas + párrafo puente.
2. Archivo en CDigital: `S05_Antecedentes_Apellido`.
