# Rompehielos de la Sesión 01 — CREATIVIDAD Y PENSAMIENTO INNOVADOR

**Grupo(s):** 54408 · **50 matriculados**
...
> `Clases/`. Regenerar: `python config/slides/build_rompehielos_slido.py creatividad`
...
Con 50 estudiantes, pedir que se presenten uno por uno no cabe en la hora, y un muro
...
El plan gratis de Slido admite **100 participantes por evento**, de sobra para los 50 de este grupo. Vas a usar 1 encuesta de las 3 gratis y el único quiz; quedan dos de reserva.
...
tres, no 50. Y hablan los que ya se ganaron el turno, no los de siempre.
...
> **Revisión 1 a 1 con el Docente** del avance del ganador, antes de Quiz 1 (19/08/2026). Media hora
...
Con 50 matriculados no llega todo el mundo a la sincrónica. Deja el evento
