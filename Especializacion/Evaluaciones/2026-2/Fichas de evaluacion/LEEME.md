...
| Archivo | Qué es |
|---|---|
| `1 - Ficha de preparacion.md` / `.docx` | las 8 secciones de siempre: resumen de 5 minutos, coherencia, fortalezas, huecos con página, preguntas antes y después, umbrales de nota, observaciones administrativas. Se lee; no se escribe en ella |
| `2 - Hoja de respuestas.md` / `.docx` | **lo único que se tiene delante en sala.** Las tres preguntas de ese grupo ya impresas, con casillas y huecos. Se llena a mano |
...
**Antes de la sala** — 5 minutos por grupo: de la ficha, solo la §1 (resumen) y la §4 (huecos con
...
- **Mover sí, borrar no.** Esto se sincroniza con Google Drive. Los `desktop.ini` son de Drive: no se
  tocan.
- **La nota la pone el jurado humano**, contra los umbrales que la §7 de cada ficha escribió *antes* de
