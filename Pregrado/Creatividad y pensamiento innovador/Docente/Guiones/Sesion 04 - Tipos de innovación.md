### GUIÓN DOCENTE — Sesión 04: Tipos de innovación
...
> **PPTX:** `Clases/Sesion 04 - Tipos de innovación/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **04** · **Tema:** Tipos de innovación
...
| **15** | TALLER · Matriz comparativa de su propuesta |
| **16** | TALLER · cómo se revisa y dónde se entrega |
| **17** | Antes de entregar: revise usted mismo |
| **18** | Para continuar — trabajo autónomo |
| **19** | Para continuar — trabajo autónomo (cont.) |
...
**GUION LITERAL:**
> “Buenas tardes. **Sesión 04**: **Tipos de innovación**. La clase pasada le pusimos una etiqueta Oslo a su propuesta. Hoy subimos el nivel: no basta con la etiqueta, hay que **argumentar por qué ese tipo y no otro**.”
...
![Docs — matriz tipos de innovación](Capturas/s01_google_docs_inicio.png)
...
![Excalidraw — cuadro comparativo](Capturas/s01_excalidraw_pizarra.png)
...
---
*Fin del Guión — Sesión 04. Documento autocontenido: un docente sin trayectoria en innovación puede estudiarlo y dictar la hora completa.*
