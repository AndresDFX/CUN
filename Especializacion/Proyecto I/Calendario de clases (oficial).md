...
> ⚠️ **Este archivo se corrigió** con el **cronograma oficial** (`Cronograma_Proyecto_I_II_Especializaciones_26ES4.pdf`, Coordinación de Gestión del Conocimiento) recibido después de la primera versión. Los pesos reales son **25% + 25% + 42% + 4% coevaluación + 4% autoevaluación**, no 25/25/50 como se había estimado antes.
...
| Actividad | Apertura | Cierre | Fecha límite nota | % | Corte |
|---|---|---|---|---|---|
| **ACA 1** — Primer avance del anteproyecto | lun 03/08/2026 | dom 30/08/2026 | lun 07/09/2026 | **25%** | I |
| **ACA 2** — Segundo avance del anteproyecto | lun 07/09/2026 | dom 04/10/2026 | lun 12/10/2026 | **25%** | II |
| **ACA 3** — Anteproyecto (final) | lun 12/10/2026 | dom 08/11/2026 | lun 16/11/2026 | **42%** | III |
| **Coevaluación** | lun 09/11/2026 | dom 15/11/2026 | dom 22/11/2026 | **4%** | III |
| **Autoevaluación** | lun 16/11/2026 | dom 22/11/2026 | dom 22/11/2026 | **4%** | III |

> El sistema de Moodle reparte operativamente estos pesos en **3 cortes** (I=25%, II=25%, III=50% = ACA3+coev.+autoev.), sin dejar de ser **nota única** para efectos del Reglamento Estudiantil.
