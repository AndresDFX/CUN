### GUIÓN DOCENTE — Sesión 01: Presentación del curso y fundamentos de investigación
...
> **PPTX:** `Clases/Sesion 01 - Presentación del curso y fundamentos de investigación/Presentacion.pptx` — en cada fase se indica la slide de ESA presentación.

📌 **De esta sesión**
- **Sesión:** **01** · **Tema:** Presentación del curso y fundamentos de investigación
- **Detalle:** ESP329 U1 · Encuadre P-I→P-II · enfoques/ética · acuerdos · tutorías · rompehielos QR/Padlet.
- **PPTX estudiante:** `Clases/Sesion 01 - Presentación del curso y fundamentos de investigación/Presentacion.pptx`
...
- **60 min tutoría:** trabajo por equipos; el estudiante registra asistencia en https://forms.gle/oZ8xCYiUo3KEWr1d9. Las tutorías por grupo se acuerdan en la semana con el Docente (no hay atención espontánea sin cita).
...
| 2️⃣ Qué es (y no es) un anteproyecto · P-I vs P-II | 12 | min 12:00 – 24:00 |
| 3️⃣ Enfoques, ética y rol del docente garante | 10 | min 24:00 – 34:00 |
| 4️⃣ Taller: ficha de encuadre del equipo / tema tentativo | 18 | min 34:00 – 52:00 |
| 5️⃣ Cierre contenido + puente a tutoría | 8 | min 52:00 – 60:00 |
...
> “Abrimos la **Presentación del Curso**, slide **PRESÉNTATE**. Escaneen el QR o abran: https://padlet.com/andres_dfx/cun-wruz81hmf9k06gd7 — también en el chat. Post-it con: (a) expectativa del curso y (b) **tema tentativo** de investigación en una frase. **~7 minutos**.”
...
> “**Slide 4 — RECUERDA.** Las tutorías por grupo se acuerdan en la semana con el Docente (no hay atención espontánea sin cita). Cada vez que asistan a tutoría, diligencien https://forms.gle/oZ8xCYiUo3KEWr1d9. Es su evidencia; el mío es otro formulario, solo docente.”
...
**Foco de hoy en tutoría:** confirmar equipos (máx. 3), línea oficial, tema tentativo; destrabar dudas de CDigital/plantilla APA.
...
- [ ] PPTX `Clases/Sesion 01 - Presentación del curso y fundamentos de investigación/Presentacion.pptx`
- [ ] Espacio de entrega en CDigital
- [ ] Link tutorías listo para chat: https://forms.gle/oZ8xCYiUo3KEWr1d9
