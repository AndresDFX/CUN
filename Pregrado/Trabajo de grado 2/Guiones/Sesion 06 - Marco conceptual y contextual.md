### GUIÓN DOCENTE — Sesión 06: Marco conceptual y contextual
...
> **PPTX:** `Clases/Sesion 06 - Marco conceptual y contextual/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **06** · **Tema:** Marco conceptual y contextual
...
> Cierre del marco referencial. Dos piezas cortas pero decisivas: definir los términos como los usa SU proyecto, y ubicar el problema en un contexto real y acotado.
...
‘Tiempo de atención’ → ‘minutos entre apertura y cierre del ticket en el sistema X’; contexto = área de soporte TI de la empresa X, no ‘Colombia’.

#### Errores frecuentes
| Error frecuente / pregunta trampa | Qué responde el docente |
| :--- | :--- |
| “Copio la definición del diccionario / Wikipedia.” | Necesita una definición operativa: acotada y medible en SU proyecto. |
| “El contexto es Colombia y el sector TI.” | Acote: el contexto es la organización, el área y el proceso concretos. |
| “Defino el término tan amplio que sirve para todo.” | Si sirve para todo, no sirve para medir; delimite a su caso. |
| “Marco conceptual y contextual son lo mismo.” | No: el conceptual define términos; el contextual describe dónde ocurre. |
...
![Scholar / Docs — definiciones](Capturas/tg_scholar.png)
