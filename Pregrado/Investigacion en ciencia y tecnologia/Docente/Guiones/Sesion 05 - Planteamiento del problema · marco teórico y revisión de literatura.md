...
🗺️ **Slides de esta presentación** (deck real: **37 slides** — no es el mapa del curso)
...
| **30** | TALLER · Planteamiento + primera página de marco |
| **31** | TALLER · cómo se revisa y dónde se entrega |
| **32** | Checklist antes de subir su entrega |
| **33** | Checklist antes de subir su entrega (cont.) |
| **34** | Trabajo autónomo · recta final hacia la ACA Final |
| **35** | Trabajo autónomo · recta final hacia la ACA Final (cont.) |
| **36** | RUTA DE ENTREGABLES DEL CURSO |
| **37** | Cierre — Sesión 05 |
...
![Google Docs — tabla de trabajo y ficha de lectura](Capturas/inv_google_docs.png)
...
![Google Académico — evidencia de respaldo](Capturas/inv_scholar_busqueda.png)

> **En pantalla:** Buscar 1 dato o estudio que sostenga el «estado actual» (no la solución) y anotarlo con su año.

![ZoteroBib — completar las referencias del marco](Capturas/inv_zoterobib.png)
