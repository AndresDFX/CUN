### GUIÓN DOCENTE — Sesión 04: Problema y pregunta · bases de datos y gestores de citas
...
> **PPTX:** `Clases/Sesion 04 - Problema y pregunta · bases de datos y gestores de citas/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **04** · **Tema:** Problema y pregunta · bases de datos y gestores de citas
...
- **PPTX estudiante:** `Clases/Sesion 04 - Problema y pregunta · bases de datos y gestores de citas/Presentacion.pptx`
...
🗺️ **Slides de esta presentación** (deck real: **33 slides** — no es el mapa del curso)

| Slide | Título en el PPTX |
| :---: | :--- |
| **1** | SESIÓN 04 — Problema y pregunta · bases de datos y gestores de citas |
| **2** | Hoy son dos cosas: la pregunta y las fuentes que la sostienen |
...
| **13** | Con la pregunta lista, la otra mitad: dónde se busca de verdad |
| **14** | Con la pregunta lista, la otra mitad: dónde se busca de verdad (cont.) |
| **15** | Buscador ≠ base de datos: cuándo usar cada uno |
| **16** | Operadores de búsqueda que ahorran horas |
| **17** | Ejemplo modelado (3/3): la misma pregunta, cuatro búsquedas |
| **18** | Ejemplo modelado (3/3): la misma pregunta, cuatro búsquedas (cont.) |
| **19** | El filtro de 60 segundos: ¿me quedo con esta fuente? |
| **20** | Paso a paso: citar en APA 7 con ZoteroBib |
| **21** | Paso a paso: citar en APA 7 con ZoteroBib (cont.) |
| **22** | Errores frecuentes: del problema a la fuente |
| **23** | Errores frecuentes: del problema a la fuente (cont.) |
| **24** | Paso a paso: el diagrama en Excalidraw y la prueba de viabilidad |
| **25** | Paso a paso: el diagrama en Excalidraw y la prueba de viabilidad (cont.) |
| **26** | TALLER · Pregunta + tres fuentes citadas |
| **27** | TALLER · cómo se revisa y dónde se entrega |
| **28** | Checklist antes de subir su entrega |
| **29** | Checklist antes de subir su entrega (cont.) |
| **30** | Trabajo autónomo · para la próxima sesión |
| **31** | Trabajo autónomo · para la próxima sesión (cont.) |
| **32** | RUTA DE ENTREGABLES DEL CURSO |
| **33** | Cierre — Sesión 04 |
...
1. **Diferenciar** un problema de investigación de «la falta de mi solución», y ordenarlo con **espina de pescado**, **árbol de problemas** o **método 3D**.
...
| :--- | :--- |
| “El problema es que no existe mi aplicación.” | Eso es un deseo de producto. Pregunte: si su app nunca existiera, ¿qué seguiría doliendo? Esa respuesta es el problema. |
| “¿Es útil la inteligencia artificial? — como pregunta.” | Es de sí/no y planetaria. Reformule con actor, lugar y «en qué medida». |
| “Confundo causas con efectos en el árbol.” | Dos preguntas los separan: «¿por qué ocurre?» señala causa; «¿qué provoca esto?» señala efecto. Causas abajo, efectos arriba. |
| “Busqué y no hay nada sobre mi tema.” | Casi nunca es que el tema no exista: buscó con lenguaje cotidiano. Tome los términos técnicos de un artículo que sí sirvió y vuelva a buscar, también en inglés. |
| “Este artículo lo tengo que pagar.” | Primero la **biblioteca CUN** con el login institucional: buena parte del texto completo ya está suscrito. |
| “¿Instalo Mendeley o Zotero de escritorio?” | No. **ZoteroBib** en el navegador genera el APA 7 gratis y sin cuenta; el escritorio no aporta nada para lo de hoy. |
| “La IA me dio tres referencias perfectas.” | La IA fabrica autor, año, revista y DOI de artículos que no existen. **Si no abrió el documento, no lo cita.** |
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre: hoy son dos cosas | 6 | min 00:00 – 06:00 |
| 2️⃣ Problema, herramientas y pregunta | 10 | min 06:00 – 16:00 |
| 3️⃣ Dónde se busca de verdad y cómo se cita | 10 | min 16:00 – 26:00 |
| 4️⃣ Taller: pregunta + tres fuentes citadas | 11 | min 26:00 – 37:00 |
| 5️⃣ Quiz 2 en CDigital (se aplica en clase) | 15 | min 37:00 – 52:00 |
| 6️⃣ Cierre y trabajo autónomo | 8 | min 52:00 – 60:00 |

> **Suma:** **60 minutos** exactos.

---

#### 1️⃣ Encuadre: hoy son dos cosas (~6 min) — Portada · «Hoy son dos cosas: la pregunta y las fuentes que la sostienen»
...
#### 2️⃣ Problema, herramientas y pregunta (~10 min) — De «Qué es (y qué no es) un problema» a «Preguntas mal formuladas y su reformulación»
**Protagonista:** Docente (exposición, ritmo alto).
...
#### 3️⃣ Dónde se busca de verdad y cómo se cita (~10 min) — De «la otra mitad: dónde se busca de verdad» a «Errores frecuentes: del problema a la fuente»
...
![Google Académico — el buscador amplio](Capturas/inv_google_scholar.png)

> **En pantalla:** Explicar comillas, AND/OR, filtro por año y el enlace «citado por». Arrancar amplio y cerrar después.

![SciELO — base regional de acceso abierto](Capturas/inv_scielo.png)

> **En pantalla:** Buscar el mismo tema en español y abrir un artículo con texto completo. Mencionar Redalyc como la segunda base y la biblioteca CUN para lo suscrito.

![ZoteroBib (zbib.org) — APA 7 sin instalar nada](Capturas/inv_zoterobib.png)

> **En pantalla:** Pegar el DOI de prueba → *Cite* → **corregir a mano** (mayúsculas, autores, DOI) → *Copy to clipboard* → pegar en el documento.

#### 4️⃣ Taller: pregunta + tres fuentes citadas (~11 min) — «Paso a paso: el diagrama en Excalidraw» → «TALLER · Pregunta + tres fuentes citadas»
...
![Google Académico — prueba de viabilidad de la pregunta](Capturas/inv_scholar_busqueda.png)

> **En pantalla:** Dos términos de la pregunta entre comillas: si aparece literatura, la pregunta es investigable. De esa misma búsqueda salen las 3 fuentes del taller.

![Google Docs — el documento del taller](Capturas/inv_google_docs.png)

> **En pantalla:** Diagrama pegado como imagen, pregunta en una frase y las 3 referencias bajo *Referencias*, en orden alfabético.


#### 5️⃣ Quiz 2 en CDigital (se aplica en clase) (~15 min) — Protagonistas: Estudiantes + Docente
> **Replaneación de hoy (la hora no crece):** la fase de evaluación toma **15 min** y por eso se recortan: Problema, herramientas y pregunta 14→10 min, Dónde se busca de verdad y cómo se cita 14→10 min, Taller: pregunta + tres fuentes citadas 18→11 min. Donde la consigna del taller diga otra cantidad de minutos, manda el plan de clase.
...
#### 6️⃣ Cierre y trabajo autónomo (~8 min) — «Checklist antes de subir» → «Trabajo autónomo» → Cierre
**Protagonista:** Docente.
