### GUIÓN DOCENTE — Sesión 04: Retroalimentación del Quiz · Antecedentes de investigación
...
📌 **De esta sesión**
- **Sesión:** **04** · **Tema:** Retroalimentación del Quiz · Antecedentes de investigación
...
- **PPTX estudiante:** `Clases/Sesion 04 - Retroalimentación del Quiz · Antecedentes de investigación/Presentacion.pptx`
...
| :--- | :--- | :---: | ---: | :--- |
| **ACA 1** | Tarea | 2 | 25% | **Abre hoy** la ventana en CDigital |

**Cómo anunciarlo (guion literal, en el cierre de la clase — no en el último minuto):**
> “Aviso de plataforma: **ACA 1** ya está **abierto** en CDigital, en la sección del corte 2. Es un **tarea** y vale **25%** del curso. Ábranlo hoy mismo aunque no lo vayan a resolver todavía: así saben cuántas preguntas tiene y cuánto tiempo les da.”
...
| :---: | :--- |
| **1** | SESIÓN 04 — Retroalimentación del Quiz · Antecedentes de investigación |
...
| **15** | TALLER · Búsqueda y fichaje de antecedentes |
...
#### 1. Cómo retroalimentar el bloque de formulación (en 60+60)
...
| :--- | :---: | :--- |
| 1️⃣ Encuadre + retro del bloque de formulación y del Quiz | 10 | min 00:00 – 10:00 |
| 2️⃣ Qué es un antecedente (y qué no) | 12 | min 10:00 – 22:00 |
| 3️⃣ Modelación de ficha de antecedente | 10 | min 22:00 – 32:00 |
| 4️⃣ Taller de búsqueda y fichas | 20 | min 32:00 – 52:00 |
...
#### 1️⃣ Encuadre + retro del bloque de formulación y del Quiz (~10 min) — Protagonista: Docente
...
**GUION LITERAL:**
> “En autónomo, completen las seis fichas mínimas y, en paralelo, vayan aplicando sobre el documento las correcciones que les devolví de la formulación. Suban el avance como `S04_Antecedentes_Apellidos`.”
> “Recuerden cómo se acumula esto: los antecedentes y el marco se suman a la formulación corregida **dentro de la misma ACA 1**, la del segundo corte. No es una entrega nueva: es el mismo archivo, más grande y mejor. Pasamos a tutoría para revisar una o dos fichas por equipo.”
...
**Foco de hoy en tutoría:** retro puntual del bloque de formulación (avance de la ACA 1) + revisar 1–2 fichas de antecedentes por equipo; confirmar que todos presentaron el Quiz.
...
---
*Fin del Guión — Sesión 04. Autocontenido para dictar 60+60.*
