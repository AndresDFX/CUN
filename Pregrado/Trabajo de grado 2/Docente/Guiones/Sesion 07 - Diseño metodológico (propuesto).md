### GUIÓN DOCENTE — Sesión 07: Diseño metodológico (propuesto)
...
📌 **De esta sesión**
- **Sesión:** **07** · **Tema:** Diseño metodológico (propuesto)
...
> Bisagra entre el "qué" y el "cómo". El estudiante debe proponer una ruta coherente para responder su pregunta. En TG2 todo es **propuesto**: aún no se ejecuta.
...
Matriz: objetivo ‘comparar tiempos’ → dato ‘tiempos antes/después’ → análisis ‘comparación de medias’; enfoque cuantitativo justificado por la pregunta.

#### Errores frecuentes
| Error frecuente / pregunta trampa | Qué responde el docente |
| :--- | :--- |
| “Elijo enfoque cualitativo porque suena más fácil.” | El enfoque se elige por la pregunta, no por comodidad: ¿mide o interpreta? |
| “Tengo método pero no sé para qué objetivo.” | Use la matriz pregunta–método: cada método debe responder a un objetivo. |
| “Escribo la metodología como si ya la hubiera hecho.” | En TG2 es ‘propuesto’: se aplicará / se propone. El campo es de TG3. |
| “Enfoque, alcance y diseño son lo mismo.” | Son tres decisiones distintas y encadenadas; defina cada una. |
...
![Referentes metodológicos](Capturas/tg_scholar.png)

> **En pantalla:** Buscar 1 documento con un método similar; copiar la lógica, no el texto.
