# Docente — Trabajo de Grado 3

**94532 · grupos 54450, 54466 y 54467** · aulas CDigital **112321, 116387 y 129270**
...
`Guiones/` — los **guiones docentes**, uno por sesión (`Sesion NN - <tema>.md`, 15 en este curso) y
`Capturas/` con los 17 pantallazos que se proyectan o se repasan antes de clase. Son **solo `.md`**:
...
Además está la **guía transversal** `Guía práctica - Herramientas de escritura y citación.md`, que
no es de ninguna sesión: los guiones remiten a ella en vez de repetir el paso a paso.
...
**Un solo banco para las tres aulas.** Esta carpeta del repositorio corresponde a **tres** aulas del
campus, y el mismo `.xml` se importa en las tres. Por eso las categorías del banco se nombran sin el
número de grupo.
...
python config/moodle/cdigital.py importar \
  "Pregrado/Trabajo de grado 3/Docente/Cuestionarios/Parcial 1 - banco de preguntas (Moodle XML).xml" \
