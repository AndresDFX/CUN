...
![Canvanizer — Business Model Canvas](Capturas/Herramientas/bmc_canvanizer.png)

> **En pantalla:** Abrir https://canvanizer.com/new/business-model-canvas; llenar 3 bloques clave en vivo.

![Strategyzer BMC (referencia visual)](Capturas/Herramientas/strategyzer_bmc.png)
...
![Excalidraw — FODA + MVP](Capturas/s01_excalidraw_pizarra.png)

> **En pantalla:** FODA 4 cuadrantes + hipótesis de MVP en 5 líneas.

![Docs — consolidar Canvas/MVP](Capturas/s01_google_docs_inicio.png)
