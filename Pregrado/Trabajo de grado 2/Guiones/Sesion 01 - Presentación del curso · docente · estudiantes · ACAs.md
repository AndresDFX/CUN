...
> **Rompehielos con grupo grande:** slide **PRESÉNTATE**, pero **sin muro**. Se responde un **formulario de Google** ([URL Formulario Preséntate — pendiente · TRABAJO DE GRADO 2], enlace por el chat del Meet) y la interacción en vivo va por las **encuestas** y el **Q&A** que ya trae Meet. Es el **mismo momento** que el de la Presentación del Curso, no dos rompehielos distintos.
...
| **7** | Cómo trabajamos: TG2 es un taller de escritura | 3 |
| **8** | Aviso honesto sobre este curso (sin Syllabus SIAC) | 3 |
| **8–9** | Mapa del curso (1/2 y 2/2): los 11 encuentros | 3 |
| **11** | Qué se llevan al final: el avance escrito | 3 |
| **12** | El acuerdo pedagógico: qué pactamos hoy | 3 |
| **13** | Las ACAs, una por una | 4 |
| **14** | Cómo se entrega, paso a paso | 4 |
| **15** | Integridad académica | 4 |
| **16** | Inteligencia artificial generativa | 4 |
| **17** | Herramientas del curso | 4 |
| **18** | Cómo pedir ayuda | 4 |
| **19** | Acuerdos de convivencia | 5 |
| **20** | Preguntas frecuentes del primer día | 5 |
| **21** | Lo que debe tener listo para la Sesión 02 | 5 |
| **22** | ACUERDOS DE TRABAJO | 5 |
| **23** | PARA LA PRÓXIMA SESIÓN | 5 |
| **24** | Cierre — Sesión 01 | 5 |
...
Deje **seis pestañas** abiertas y páselas en este orden, sin buscar nada en vivo:
...
| “¿Y si el lunes es festivo?” | “La sesión no se cancela: es **clase autónoma**. Ese lunes yo les dejo la actividad en la carpeta de esa sesión, en el **Drive de clases** —la misma carpeta donde están los decks—, y ustedes la trabajan. Cuenta igual, y si hay algo que entregar, se entrega en CDigital como siempre.” |
| “¿La clase se graba?” | Dígalo con claridad según lo que usted vaya a hacer, y aclare lo fijo: “el material y la consigna quedan siempre en la carpeta de esa sesión, en el **Drive de clases**; CDigital es para entregar y para las notas”. |
...
| 2️⃣ Preséntate: formulario del curso + encuesta en vivo | 10 | min 10:00 – 20:00 |
...
#### 2️⃣ Preséntate: formulario del curso + encuesta en vivo (~10 min) — Slide 4 (PRESÉNTATE — formulario del curso)
**Protagonista:** Estudiantes (formulario) · Docente conduce.

**En pantalla:** Presentación del Curso → slide **PRESÉNTATE**. Enlace del formulario: [URL Formulario Preséntate — pendiente · TRABAJO DE GRADO 2] — **péguelo en el chat del Meet**, no lo dicte.
...
> “**Slide 13 — ítem por ítem.** Los quices y los parciales **caen en día de clase**: se abren en el encuentro, tienen tiempo y cierran ese mismo día; el que falte ese día pierde el ítem, no lo ‘recupera después’. La **ACA Final** es el documento acumulativo: el mismo texto que venimos escribiendo, en PDF, subido a CDigital. La **autoevaluación** se diligencia y la **coevaluación** es un **foro**: se escribe en él, con criterio, o no cuenta.”

> “**Slide 14 — Cómo se entrega.** Puro procedimiento, y les ahorra sustos.” [Hágalo en vivo: abra la plantilla APA CUN en Google Docs, muestre el nombre `SNN_Tema_Apellido`, descargue como PDF y abra el espacio de entrega en CDigital.] “Y una regla de TG2: **trabajen siempre sobre el mismo documento**. Aquí se evalúa un texto que crece, no una carpeta de archivos sueltos.”

> “**Slide 15 — Integridad académica.** En trabajo de grado esto se revisa de verdad. Todo lo que no es suyo se cita en APA 7, incluidos los fragmentos de su propio trabajo anterior: reutilizarlos sin declararlo es **autoplagio**. En TG3 la entrega pasa por la revisión de similitud institucional del aula, y allá el Docente confirma cómo opera; así que el hábito lo corregimos aquí. Y el consejo práctico: anoten la fuente en el instante en que pegan algo; en un documento que crece seis meses, reconstruirla después es imposible.”

> “**Slide 16 — Inteligencia artificial.** Hablemos claro. Sí se puede usar para entender un concepto, ordenar una sección o pulir un párrafo que ustedes ya escribieron. Se declara en una línea al final. Y verifiquen cada referencia, porque estas herramientas inventan autores y DOIs. Piensen en el semestre que viene: en TG3 hay sustentación ante jurados, y un párrafo que usted no pueda explicar en voz alta le va a costar caro.”

> “**Slide 17 — Herramientas.** Todas gratis y en el navegador: Docs, Google Académico, SciELO, Redalyc, biblioteca CUN, ZoteroBib para las citas, Excalidraw para diagramar y CDigital para entregar. No hay que instalar ni comprar nada.”

> “**Slide 18 — Cómo pedir ayuda.** Foro de CDigital para lo académico, correo para lo personal, respuesta en días hábiles y siempre antes del siguiente encuentro. Y pidan ayuda **con el texto en la mano**: miren los dos ejemplos de la slide.”
...
> “**Slides 22 y 22 — Acuerdos y para la próxima.** Resumo el trato: se entrega en CDigital, se trae el avance escrito y se cita en APA 7.”

> “**Slide 24 — Cierre.** Ya saben qué vamos a hacer, cómo se evalúa y qué pactamos. La próxima sesión abrimos con sus matrices en pantalla y convertimos ese tema en pregunta, objetivos y título. Recuerden: si un lunes cae festivo, esa sesión es autónoma y la actividad la buscan en la carpeta de esa sesión, en el Drive de clases; el resto nos vemos en el mismo Meet.”
...
- [ ] **Formulario «Preséntate»** creado y probado desde otra cuenta, con el enlace listo para pegar en el chat: [URL Formulario Preséntate — pendiente · TRABAJO DE GRADO 2]
