### GUIÓN DOCENTE — Sesión 04: Estructura del artículo · taller de introducción
...
> **PPTX:** `Clases/Sesion 04 - Estructura del artículo · taller de introducción/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **04** · **Tema:** Estructura del artículo · taller de introducción
- **Detalle:** Contexto, problema, pregunta y objetivos.
- **PPTX estudiante:** `Clases/Sesion 04 - Estructura del artículo · taller de introducción/Presentacion.pptx`
...
#### Enfoque
Estructura del artículo + taller de introducción.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **04**: *Estructura del artículo · taller de introducción*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Introducción con gancho, vacío y propósito. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Estructura del artículo · taller de introducción*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S04_Avance_Apellido` en CDigital.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Introducción con gancho, vacío y propósito.
2. Archivo en CDigital: `S04_Avance_Apellido` en CDigital.
