### GUIÓN DOCENTE — Introducción · Propuesta de Innovación (trabajo final)
...
- **Orden en el calendario:** encuentro #1 · **Fecha ref.:** 05/08/2026 · **Bloque:** U1
- **Temática oficial:** Introducción · Propuesta de Innovación (trabajo final)
- **Detalle fuente:** Syllabus · acuerdos · anunciar el trabajo final desde el día 1.
...
- **PPTX estudiante:** `Clases/Temas/Introducción · Propuesta de Innovación (trabajo final).pptx`

🎯 **Objetivos**
* Que el estudiante comprenda el alcance del tema **Introducción · Propuesta de Innovación (trabajo final)**.
...
> “Buenas tardes. Hoy trabajamos *Introducción · Propuesta de Innovación (trabajo final)*. Al terminar deben salir con un avance
...
- [ ] Tengo la presentación `Clases/Temas/Introducción · Propuesta de Innovación (trabajo final).pptx`
