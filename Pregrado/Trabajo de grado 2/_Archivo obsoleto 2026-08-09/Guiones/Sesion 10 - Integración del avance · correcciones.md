### GUIÓN DOCENTE — Sesión 10: Integración del avance · correcciones
...
> **PPTX:** `Clases/Sesion 10 - Integración del avance · correcciones/Presentacion.pptx`

📌 **De esta sesión**
- **Sesión:** **10** · **Tema:** Integración del avance · correcciones
- **Detalle:** Documento consolidado.
- **PPTX estudiante:** `Clases/Sesion 10 - Integración del avance · correcciones/Presentacion.pptx`
...
Lectura de coherencia global; lista priorizada de correcciones.
...
**GUION LITERAL:**
> “Buenas tardes. Sesión **10**: *Integración del avance · correcciones*. Al terminar esta hora deben salir con un **avance observable**. Slide 2: objetivos de hoy.”
...
**En pantalla (Google Docs / Excalidraw):** Semáforo por sección.
...
**GUION LITERAL:**
> “**Slide 5 — TALLER.** Tienen ~20 minutos. Consigna: Matriz de gaps + dueños. Criterio de éxito: si yo leo su avance sin conocerlos, entiendo el punto. Al final, 2–3 personas comparten 30 segundos.”
...
**GUION LITERAL:**
> “Tres ideas de hoy: (1) el concepto central de *Integración del avance · correcciones*; (2) el avance debe ser **observable**; (3) el hilo del curso continúa. **Slide 6 — PARA CONTINUAR:** suban a CDigital `S10_Integracion_Apellido`.. **Slide 7:** gracias; mismo Meet la próxima.”

---

🧩 **Entregable de hoy**
1. Matriz de gaps + dueños.
2. Archivo en CDigital: `S10_Integracion_Apellido`.
