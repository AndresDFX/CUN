...
| **Evento de Slido** del curso | Creado y probado desde el celular, con el **quiz de 3 preguntas** montado (una por ronda), **una encuesta A/B/C** vacía para la ronda final y el **Q&A abierto**. El **código del evento** copiado para pegarlo en el chat | Es el rompehielos entero. Enlace del evento: [URL Slido — evento del rompehielos pendiente · PROYECTO I] |
| **Las tres rondas, con la mentira ya marcada** | `Proyecto I/2026/54ES4/Rompehielos Slido - Sesion 01.md` diligenciado **antes** de entrar a la sala | Ahí están las frases y las casillas donde usted marca cuál es la mentira de cada ronda. Es material del Docente: **no** va en `Clases/`. Si llega a clase sin marcarlas, el juego se cae |
...
| 3️⃣ Rompehielos: «Dos verdades y una mentira» en Slido | 8 | min 09:00 – 17:00 |
| 4️⃣ Recorrido del curso y su producto final | 10 | min 17:00 – 27:00 |
| 5️⃣ Las ACAs y cómo se entrega | 13 | min 27:00 – 40:00 |
...
> perdió la sala. Evento de Slido: [URL Slido — evento del rompehielos pendiente · PROYECTO I]
...
**Slides:** 17 (Antes de la Sesión 02) → 18 (Las preguntas que siempre salen el primer día) → 20 (PARA LA PRÓXIMA SESIÓN) → 21 (RUTA DE ENTREGABLES DEL CURSO) → 22 (Cierre)
...
- [ ] **Las tres rondas ajustadas y la mentira de cada una marcada** en `Proyecto I/2026/54ES4/Rompehielos Slido - Sesion 01.md` *(material del Docente — sin esto el juego no se puede jugar)*
- [ ] **Evento de Slido** creado y probado desde el celular, con el **quiz de 3 preguntas**, la **encuesta A/B/C** de la ronda final y el **Q&A abierto**; el **código** copiado para el chat: [URL Slido — evento del rompehielos pendiente · PROYECTO I]
