...
> **Rompehielos con grupo grande:** slide **PRESÉNTATE**, pero **sin muro** y **sin ronda hablada**: se juega **«dos verdades y una mentira»** sobre el Docente en **Slido** ([URL Slido — evento del rompehielos pendiente · TRABAJO DE GRADO 3]; el estudiante entra a slido.com con el **código** que el Docente pega en el chat del Meet). Ocho minutos: tres rondas, tabla de posiciones y una ronda final en la que el podio se presenta. Es el **mismo momento** que el de la Presentación del Curso, no dos rompehielos distintos.
> **Las tres rondas y cuál es la mentira de cada una están en `Trabajo de grado 3/2026/_combinado_todos/Rompehielos Slido - Sesion 01.md`** —material del Docente, no va en `Clases/`— y **se marcan antes de la clase**.
...
| :--- | :--- | :---: | ---: | :--- |
| **ACA Final** | Tarea | 3 | 32% | **Abre hoy** la ventana en CDigital |
...
| **22** | RUTA DE ENTREGABLES DEL CURSO | |
| **23** | Cierre — Sesión 01 | 5 |

🎯 **Objetivos de la sesión**
1. **Encuadrar** TG3 como **culminación**: cómo se usa la hora sincrónica, qué se hace en autónomo y cuál es el producto (**documento + sustentación + repositorio**).
...
> Este grupo llega con dos cargas: un proyecto heredado que casi nadie tiene ordenado y la ansiedad de la **sustentación ante jurados**. El encuadre tiene que nombrar las dos cosas hoy; nadie debería enterarse en la sesión 12 de que hay defensa oral.
...
| **Las tres rondas ajustadas y la mentira de cada una marcada** en `Trabajo de grado 3/2026/_combinado_todos/Rompehielos Slido - Sesion 01.md` | Es material del Docente y **no** va en `Clases/`. Se marca **antes** de entrar a la sala: llegar sin marcarlas es llegar sin juego |
...
| :--- | :--- |
| “¿Hoy no vamos a ver tema?” | “Hoy es el encuadre: cómo trabajamos, qué se entrega y qué pactamos. Los casos de éxito y el retomar el proyecto son su lectura de esta semana; los abrimos en la Sesión 02.” |
| “¿Puedo cambiar de tema?” | “No a estas alturas, salvo fuerza mayor y hablado conmigo. TG3 culmina un proyecto: cambiarlo aquí es no llegar a sustentar.” |
| “¿50 referencias no es imposible?” | “No: se arrastran las de TG2 y se suman las nuevas cada semana. Lo imposible es reunirlas la última semana.” |
| “¿Me sirve lo que hice en TG2?” | “Sí, y mucho: se reutiliza lo que está bien y se reescribe lo débil. Eso es exactamente la matriz de herencia que les encargo hoy.” |
| “¿Puedo trabajar solo o en grupo?” | “Según lo que autorice el programa para su opción de grado. Consúltelo hoy y lo dejamos escrito en el acuerdo pedagógico.” |
| “¿Cuándo es la entrega final?” | “Depende de su grupo: hay calendarios distintos. Busque el suyo en la Presentación del Curso y en CDigital, y anótelo hoy mismo.” |
| “¿La sustentación es en vivo, ante quién?” | “Ante jurados, y pesa tanto como todo el trabajo escrito. Se prepara desde ahora: cada sección que escriba es material de esa defensa.” |
...
| “¿Por qué no nos presentamos todos?” | “Porque somos **112** en la misma sala: presentarnos de a treinta segundos se lleva la hora entera. Por eso jugamos: en el juego participan los 112 a la vez, y el turno de hablar se lo ganan los tres del podio. El que quiera decir algo más lo escribe en el Q&A, que queda abierto y lo leo completo.” |
| “¿Puedo usar ChatGPT?” | “Como apoyo sí, y se declara al final del documento. Verifique cada referencia: inventa autores y DOIs, y esa bibliografía va al repositorio institucional.” |
...
| 2️⃣ Rompehielos: «Dos verdades y una mentira» en Slido | 8 | min 10:00 – 18:00 |
| 3️⃣ Recorrido del curso, producto final y acuerdo pedagógico | 15 | min 18:00 – 33:00 |
| 4️⃣ Cómo se evalúa (quices, parciales y ACA Final), entrega e integridad | 18 | min 33:00 – 51:00 |
| 5️⃣ Acuerdos, encargo autónomo y cierre | 9 | min 51:00 – 60:00 |
...
#### 2️⃣ Rompehielos: «Dos verdades y una mentira» en Slido (~8 min) — Slide 4 (PRESÉNTATE — juego en Slido)
**Protagonista:** Estudiantes (juegan) · Docente conduce.

**En pantalla:** Presentación del Curso → slide **PRESÉNTATE**, y al lado el evento de Slido en modo presentación. Evento: [URL Slido — evento del rompehielos pendiente · TRABAJO DE GRADO 3] — el estudiante **no** necesita esa URL: entra a **slido.com** con el **código**, que usted **pega en el chat del Meet** y no dicta.

> ⚠️ **Antes de entrar a la sala.** Las **tres rondas** y **cuál es la mentira de cada una** están en
> `Trabajo de grado 3/2026/_combinado_todos/Rompehielos Slido - Sesion 01.md` — es el runbook de la serie completa, por eso vive en `_combinado_todos/`: los tres grupos juegan juntos en el mismo Meet. Material del Docente, no va en `Clases/`. **Márquelas ahí antes de la clase** y ajústelas a su vida: si las frases no son suyas, el juego no funciona. Aquí no se repiten a propósito: este guion se comparte, y una mentira escrita en él deja de ser mentira.
...
#### 3️⃣ Recorrido del curso, producto final y acuerdo pedagógico (~15 min) — Slides 6–10 (cómo trabajamos · producto · mapa · acuerdo)
...
#### 4️⃣ Cómo se evalúa (quices, parciales y ACA Final), entrega e integridad (~18 min) — Slides 5 y 11–16 (evaluación real del aula · entrega · integridad · IA · herramientas · ayuda)
**Protagonista:** Docente, compartiendo pantalla (CDigital + libro de calificaciones + plantilla APA).

**GUION LITERAL:**
> “**Slide 5 — Cómo se evalúa TG3.** Aquí tengo que corregir algo que circula desde semestres pasados: **TG3 no es un corte único de 100%** con un ‘proceso’ y un ‘examen’. Abran su aula y miren el libro de calificaciones: son **tres cortes**, y los ítems son **Quiz 1 6% + Parcial 1 24%** en el primero, **Quiz 2 9% + Parcial 2 21%** en el segundo y **ACA Final 32% + Quiz 3 4% + Autoevaluación 2% + Coevaluación 2%** en el tercero. Si alguien les dijo otra cosa, la fuente que manda es CDigital.”

> “Lo que eso significa para ustedes: los **cuestionarios suman 66% del curso**, y caen **en día de clase**. El documento —la **ACA Final**, 32%— sigue siendo la pieza grande, pero no es la única, y no se puede llegar al final con todo pendiente. Y las **fechas cambian por grupo**: cada quien anota la de su aula, no la del compañero.”
...
> **En pantalla:** Muéstrelo 30 segundos: pegar DOI o título → APA 7 → copiar al Doc. Responde “¿con qué gestor citamos?”.


#### 5️⃣ Acuerdos, encargo autónomo y cierre (~9 min) — Slides 17–22 (convivencia · dudas · Sesión 02 · acuerdos · cierre)
**Protagonista:** Docente.
...
> “**Slide 23 — Cierre.** Ya saben qué vamos a hacer, cómo se evalúa y qué pactamos. La próxima sesión abrimos con sus matrices en pantalla y formulamos la pregunta, los objetivos y el título definitivos. Gracias, buen arranque, y nos vemos el próximo martes en el mismo Meet.”
...
2. Archivo en CDigital: `S01_AcuerdoRetoma_Apellido` (Google Doc o PDF), **antes de la Sesión 02**.
...
- [ ] **ACA Final** (Tarea · 32% · corte 3) **habilitado hoy** en CDigital y anunciado en clase (su ventana abre en esta sesión)
...
- [ ] **Las tres rondas ajustadas y la mentira de cada una marcada** en `Trabajo de grado 3/2026/_combinado_todos/Rompehielos Slido - Sesion 01.md` *(material del Docente — sin esto no hay juego)*
- [ ] **Evento de Slido** creado y probado desde el celular, con el **quiz de 3 preguntas**, la **encuesta A/B/C** de la ronda final y el **Q&A abierto**; el **código** listo para el chat: [URL Slido — evento del rompehielos pendiente · TRABAJO DE GRADO 3]
